...
bool ViewportCuller::Face::inFront(
    double x0,
    double y0,
    double z0,
    double x1,
...
bool ViewportCuller::Face::fullyInFront(
    double x0,
    double y0,
    double z0,
    double x1,
...
bool ViewportCuller::cubeInFrustum(
    double x0,
    double y0,
    double z0,
    double x1,
...
bool ViewportCuller::cubeFullyInFrustum(
    double x0,
    double y0,
    double z0,
    double x1,
