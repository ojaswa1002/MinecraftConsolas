...
void MobRenderer::renderModel(
    ...
    std::shared_ptr<Player> player =
        dynamic_pointer_cast<Player>(Minecraft::GetInstance()->player);
...
void MobRenderer::setupPosition(
...
int MobRenderer::prepareArmorOverlay(
    std::shared_ptr<Mob> mob,
    int                  layer,
    float                a
) {
