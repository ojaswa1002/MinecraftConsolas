...
protected:
    ...
    virtual void
    setupPosition(std::shared_ptr<Mob> mob, double x, double y, double z);
    virtual void
    setupRotations(std::shared_ptr<Mob> mob, float bob, float bodyRot, float a);
    ...
    virtual int
    prepareArmorOverlay(std::shared_ptr<Mob> mob, int layer, float a);
    virtual int prepareArmor(std::shared_ptr<Mob> mob, int layer, float a);
    virtual void
    prepareSecondPassArmor(std::shared_ptr<Mob> mob, int layer, float a);
    ...
    virtual void
    renderName(std::shared_ptr<Mob> mob, double x, double y, double z);
    virtual void renderNameTag(
