...
public:
    ...
    static void creativeDestroyBlock(
        Minecraft*           minecraft,
...
public:
    ...
    virtual void
    attack(std::shared_ptr<Player> player, std::shared_ptr<Entity> entity);
    virtual bool
    interact(std::shared_ptr<Player> player, std::shared_ptr<Entity> entity);
    ...
    virtual void
    handleCreativeModeItemAdd(std::shared_ptr<ItemInstance> clicked, int slot);
    virtual void
    handleCreativeModeItemDrop(std::shared_ptr<ItemInstance> clicked);
    ...
    virtual void
    handleDebugOptions(unsigned int uiVal, std::shared_ptr<Player> player);
