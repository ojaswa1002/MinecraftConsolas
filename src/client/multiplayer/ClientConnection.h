...
public:
    ...
    virtual void
    handleTileEntityData(std::shared_ptr<TileEntityDataPacket> packet);
    virtual void
    ...
    virtual void
    handleGameEvent(std::shared_ptr<GameEventPacket> gameEventPacket);
    virtual void
    ...
    // 4J Added
    static int HostDisconnectReturned(
        void*                      pParam,
        int                        iPad,
        C4JStorage::EMessageResult result
    );
    static int ExitGameAndSaveReturned(
        void*                      pParam,
        int                        iPad,
        C4JStorage::EMessageResult result
    );
