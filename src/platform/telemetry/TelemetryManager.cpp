...
bool CTelemetryManager::RecordLevelStart(
    int                iPad,
...
bool CTelemetryManager::RecordLevelExit(
    int                  iPad,
...
bool CTelemetryManager::RecordLevelSaveOrCheckpoint(
    int iPad,
...
bool CTelemetryManager::RecordMenuShown(
    int      iPad,
    EUIScene menuID,
...
bool CTelemetryManager::RecordAchievementUnlocked(
    int iPad,
    int achievementID,
...
bool CTelemetryManager::RecordUpsellPresented(
    int           iPad,
...
bool CTelemetryManager::RecordTexturePackLoaded(
    int  iPad,
    int  texturePackId,
    bool purchased
) {
