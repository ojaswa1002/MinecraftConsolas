...
#undef __in
#undef __out
#include "ps3/miles sound system/include/mss.h"
#elif defined(__PSVITA__)
#include "psvita/miles sound system/include/mss.h"
#elif defined _DURANGO
// 4J Stu - Temp define to get Miles to link, can likely be removed when we get
// a new version of Miles
#define _SEKRIT
#include "durango/miles sound system/include/mss.h"
#elif defined _WINDOWS64
#else // PS4
// 4J Stu - Temp define to get Miles to link, can likely be removed when we get
// a new version of Miles
#define _SEKRIT2
#include "orbis/miles sound system/include/mss.h"
#endif
...
public:
    ...
    virtual void
    play(int iSound, float x, float y, float z, float volume, float pitch) = 0;
    virtual void playStreaming(
    ...
    virtual char*
    ConvertSoundPathToName(const std::wstring& name, bool bConvertSpaces) = 0;
