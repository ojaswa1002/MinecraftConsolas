...
public:
    ...
    virtual bool
    Initialise(CGameNetworkManager* pGameNetworkManager, int flagIndexSize) = 0;
    ...
    virtual int JoinGame(
        ...
        int                dwLocalUsersMask,
        int                dwPrimaryUserIndex
    ) = 0;
...
public:
    virtual std::vector<FriendSessionInfo*>*
                 GetSessionList(int iPad, int localPlayers, bool partyOnly) = 0;
