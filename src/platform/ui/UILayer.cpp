...
#include "platform/ui/components/UIComponent_Chat.h"
#include "platform/ui/components/UIComponent_DebugUIConsole.h"
#include "platform/ui/components/UIComponent_DebugUIMarketingGuide.h"
#include "platform/ui/components/UIComponent_Logo.h"
#include "platform/ui/components/UIComponent_MenuBackground.h"
#include "platform/ui/components/UIComponent_Panorama.h"
#include "platform/ui/components/UIComponent_PressStartToPlay.h"
#include "platform/ui/components/UIComponent_Tooltips.h"
#include "platform/ui/components/UIComponent_TutorialPopup.h"
#include "platform/ui/components/UIScene_HUD.h"
#include "platform/ui/scenes/UIScene_ConnectingProgress.h"
#include "platform/ui/scenes/UIScene_FullscreenProgress.h"
#include "platform/ui/scenes/UIScene_Keyboard.h"
#include "platform/ui/scenes/UIScene_MessageBox.h"
#include "platform/ui/scenes/UIScene_QuadrantSignin.h"
#include "platform/ui/scenes/UIScene_Timer.h"
#include "platform/ui/scenes/debug/UIScene_DebugCreateSchematic.h"
#include "platform/ui/scenes/debug/UIScene_DebugOptions.h"
#include "platform/ui/scenes/debug/UIScene_DebugOverlay.h"
#include "platform/ui/scenes/debug/UIScene_DebugSetCamera.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_CreateWorldMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_DLCMainMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_DLCOffersMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_EULA.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_Intro.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_JoinMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_LaunchMoreOptionsMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_LeaderboardsMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_LoadMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_LoadOrJoinMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_MainMenu.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_SaveMessage.h"
#include "platform/ui/scenes/frontend_menu_screens/UIScene_TrialExitUpsell.h"
#include "platform/ui/scenes/help_and_options/UIScene_ControlsMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_Credits.h"
#include "platform/ui/scenes/help_and_options/UIScene_HelpAndOptionsMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_HowToPlay.h"
#include "platform/ui/scenes/help_and_options/UIScene_HowToPlayMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_ReinstallMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsAudioMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsControlMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsGraphicsMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsOptionsMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SettingsUIMenu.h"
#include "platform/ui/scenes/help_and_options/UIScene_SkinSelectMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_CraftingMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_DeathMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_EndPoem.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_InGameHostOptionsMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_InGameInfoMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_InGamePlayerOptionsMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_PauseMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_SignEntryMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/UIScene_TeleportMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_AnvilMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_BrewingStandMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_ContainerMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_CreativeMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_DispenserMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_EnchantingMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_FurnaceMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_InventoryMenu.h"
#include "platform/ui/scenes/ingame_menu_screens/containers/UIScene_TradingMenu.h"
...
void UILayer::tick() {
    ...
    // for(auto it,m_sceneStack.rbegin( = t,m_sceneStack.rbegin(); it !=
    // m_sceneStack.rend(); ++it)
...
void UILayer::PrintTotalMemoryUsage(
    std::int64_t& totalStatic,
    std::int64_t& totalDynamic
) {
    ...
    app.DebugPrintf(
        app.USER_SR,
        "  \\- Layer static: %d , Layer dynamic: %d\n",
        layerStatic,
        layerDynamic
    );
