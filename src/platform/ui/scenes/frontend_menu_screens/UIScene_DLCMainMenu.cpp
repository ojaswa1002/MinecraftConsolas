...
#include "platform/network/sony/SonyCommerce.h"
#endif
...
void UIScene_DLCMainMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
...
void UIScene_DLCMainMenu::handlePress(F64 controlId, F64 childId) {
    ...
    case eControl_OffersList: {
        ...
        // Xbox One will have requested the marketplace content - there is only
        // that type
#ifndef _XBOX_ONE
    ...
    case PLAYER_ONLINE_TIMER_ID:
        ...
        if (ProfileManager.IsSignedInLive(ProfileManager.GetPrimaryPad())
            ...
            C4JStorage::EMessageResult result = ui.RequestMessageBox(
                ...
                UIScene_DLCMainMenu::ExitDLCMainMenu,
                this,
                app.GetStringTable()
            );
        }
