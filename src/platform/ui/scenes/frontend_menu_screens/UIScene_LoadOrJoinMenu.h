...
public:
    static int LoadSaveDataThumbnailReturned(
        LPVOID lpParam,
        PBYTE  pbThumbnail,
...
private:
    ...
    static void remoteStorageGetSaveCallback(
        LPVOID                    lpParam,
    ...
    static void
    RequestFileSize(SaveTransferStateContainer* pClass, wchar_t* filename);
    static void
    RequestFileData(SaveTransferStateContainer* pClass, wchar_t* filename);
    static int SaveTransferReturned(
        LPVOID                                 lpParam,
        C4JStorage::SAVETRANSFER_FILE_DETAILS* pSaveTransferDetails
    );
    static int
    SaveTransferUpdateProgress(LPVOID lpParam, unsigned long ulBytesReceived);
    static void CancelSaveTransferCallback(LPVOID lpParam);
    static int  NeedSyncMessageReturned(
         void*                      pParam,
         int                        iPad,
         C4JStorage::EMessageResult result
     );
    ...
    static int CrossSaveGetSavesInfoCallback(
        LPVOID        lpParam,
        SAVE_DETAILS* pSaveDetails,
        bool          bRes
    );
    static int
    LoadCrossSaveDataCallback(void* pParam, bool bIsCorrupt, bool bIsOwner);
    ...
    static void SaveTransferReturned(
        LPVOID                    lpParam,
        SonyRemoteStorage::Status s,
        int                       error_code
    );
    ...
    static void SaveUploadReturned(
        LPVOID                    lpParam,
        SonyRemoteStorage::Status s,
        int                       error_code
    );
...
#if defined _XBOX_ONE || defined __ORBIS__
    static int CopySaveDialogReturned(
        void*                      pParam,
        int                        iPad,
        C4JStorage::EMessageResult result
    );
    static int CopySaveThreadProc(LPVOID lpParameter);
    static int CopySaveDataReturned(
        LPVOID                     lpParameter,
        bool                       success,
