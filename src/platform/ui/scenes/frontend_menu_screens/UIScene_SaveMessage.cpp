...
void UIScene_SaveMessage::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
...
void UIScene_SaveMessage::handlePress(F64 controlId, F64 childId) {
    ...
    case eControl_Confirm:
        ...
        // wait for the profile to be read - this has been kicked off earlier,
        // so should be read by now
    ...
    case PROFILE_LOADED_TIMER_ID: {
        ...
        case C4JStorage::eOptions_Callback_Read_Corrupt:
            ...
            app.SetOptionsCallbackStatus(
                0,
                C4JStorage::eOptions_Callback_Read_CorruptDeletePending
            );
            m_bIgnoreInput = false;
