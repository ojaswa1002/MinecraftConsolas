...
: UIScene(iPad, parentLayer) {
    ...
    m_ButtonDone.init(
        L"Done",
        0
    ); // only the done button needs an id, the others will never call back!
...
void UIScene_Keyboard::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
