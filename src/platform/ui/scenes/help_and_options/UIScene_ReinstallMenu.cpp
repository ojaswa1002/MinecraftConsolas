...
UIScene_ReinstallMenu::UIScene_ReinstallMenu(
    int      iPad,
    void*    initData,
    UILayer* parentLayer
)
...
void UIScene_ReinstallMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
