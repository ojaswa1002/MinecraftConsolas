...
: UIScene(iPad, parentLayer) {
    ...
    m_checkboxSplitscreen.init(
        app.GetString(IDS_CHECKBOX_VERTICAL_SPLIT_SCREEN),
    ...
    m_checkboxShowSplitscreenGamertags.init(
        ...
        (app.GetGameSettings(m_iPad, eGameSetting_DisplaySplitscreenGamertags)
         != 0)
    );
...
void UIScene_SettingsUIMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
