...
: UIScene(iPad, parentLayer) {
    ...
    if (app.GetGameHostOption(eGameHostOption_CheatsEnabled)
        ...
        m_buttonTeleportToPlayer.init(
            app.GetString(IDS_TELEPORT_TO_PLAYER),
            eControl_TeleportToPlayer
        );
        m_buttonTeleportToMe.init(
            app.GetString(IDS_TELEPORT_TO_ME),
...
void UIScene_InGameHostOptionsMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
