...
UIScene_TradingMenu::UIScene_TradingMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
...
void UIScene_TradingMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
