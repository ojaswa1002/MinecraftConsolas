...
UIScene_InventoryMenu::UIScene_InventoryMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
: UIScene_AbstractContainerMenu(iPad, parentLayer) {
    ...
    initData->player->awardStat(
        GenericStats::openInventory(),
    ...
    addTimer(
        INVENTORY_UPDATE_EFFECTS_TIMER_ID,
...
void UIScene_InventoryMenu::GetPositionOfSection(
...
void UIScene_InventoryMenu::GetItemScreenData(
    ESceneSection eSection,
    int           iItemIndex,
    UIVec2D*      pPosition,
    UIVec2D*      pSize
...
void UIScene_InventoryMenu::setSectionSelectedSlot(
    ESceneSection eSection,
    int           x,
    int           y
) {
