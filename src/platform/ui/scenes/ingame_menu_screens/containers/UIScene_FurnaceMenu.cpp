...
UIScene_FurnaceMenu::UIScene_FurnaceMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
...
void UIScene_FurnaceMenu::GetPositionOfSection(
...
void UIScene_FurnaceMenu::GetItemScreenData(
    ESceneSection eSection,
    int           iItemIndex,
    UIVec2D*      pPosition,
    UIVec2D*      pSize
...
void UIScene_FurnaceMenu::setSectionSelectedSlot(
    ESceneSection eSection,
    int           x,
    int           y
) {
