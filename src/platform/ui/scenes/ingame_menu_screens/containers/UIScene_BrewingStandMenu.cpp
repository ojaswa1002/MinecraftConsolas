...
UIScene_BrewingStandMenu::UIScene_BrewingStandMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
: UIScene_AbstractContainerMenu(iPad, parentLayer) {
    ...
    Initialize(
        ...
        menu,
        true,
        BrewingStandMenu::INV_SLOT_START,
    ...
    for (unsigned int i = 0; i < 3; ++i) {
        m_slotListBottles[i].addSlots(
            BrewingStandMenu::BOTTLE_SLOT_START + i,
            1
        );
    }
...
void UIScene_BrewingStandMenu::GetPositionOfSection(
...
void UIScene_BrewingStandMenu::GetItemScreenData(
    ESceneSection eSection,
    int           iItemIndex,
    UIVec2D*      pPosition,
    UIVec2D*      pSize
...
void UIScene_BrewingStandMenu::setSectionSelectedSlot(
    ESceneSection eSection,
    int           x,
    int           y
) {
