...
UIScene_AnvilMenu::UIScene_AnvilMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
...
void UIScene_AnvilMenu::GetPositionOfSection(
...
void UIScene_AnvilMenu::GetItemScreenData(
    ESceneSection eSection,
    int           iItemIndex,
    UIVec2D*      pPosition,
    UIVec2D*      pSize
...
void UIScene_AnvilMenu::setSectionSelectedSlot(
    ESceneSection eSection,
    int           x,
    int           y
) {
...
void UIScene_AnvilMenu::handleEditNamePressed() {
    ...
    case XC_LANGUAGE_TCHINESE:
        ...
        break;
    default:
        // 4J Stu - Use a different keyboard for non-asian languages so we don't
        // have prediction on
        InputManager.RequestKeyboard(
            app.GetString(IDS_TITLE_RENAME),
            m_textInputAnvil.getLabel(),
...
void UIScene_AnvilMenu::setCostLabel(
