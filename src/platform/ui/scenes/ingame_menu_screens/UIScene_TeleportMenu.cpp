...
: UIScene(iPad, parentLayer) {
    ...
    g_NetworkManager.RegisterPlayerChangedCallback(
        m_iPad,
        &UIScene_TeleportMenu::OnPlayerChanged,
        this
    );
...
void UIScene_TeleportMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
...
void UIScene_TeleportMenu::OnPlayerChanged(
    void*           callbackParam,
