...
: UIScene(iPad, parentLayer) {
    ...
    if (m_editingSelf) {
     ...
     || defined(_FINAL_BUILD) && !defined(_DEBUG_MENUS_ENABLED))
        ...
        if (cheats) {
            ...
            bool inCreativeMode = Player::getPlayerGamePrivilege(
                                      m_playerPrivileges,
                                      Player::ePlayerGamePrivilege_CreativeMode
                                  )
                               != 0;
            if (inCreativeMode) {
                ...
                m_checkboxes[eControl_HostFly].init(
        ...
        /*if(localPlayer->IsHost() && cheats )
        {
            ...
            bool checked = Player::getPlayerGamePrivilege(m_playerPrivileges,
    ...
    g_NetworkManager.RegisterPlayerChangedCallback(
        m_iPad,
        &UIScene_InGamePlayerOptionsMenu::OnPlayerChanged,
        this
    );
...
void UIScene_InGamePlayerOptionsMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
    ...
    case eControl_Kick: {
        ...
        *smallId      = m_networkSmallId;
        ...
        ui.RequestMessageBox(
            ...
            2,
            m_iPad,
            &UIScene_InGamePlayerOptionsMenu::KickPlayerReturned,
            smallId,
            app.GetStringTable(),
            NULL,
            0,
...
void UIScene_InGamePlayerOptionsMenu::OnPlayerChanged(
    void*           callbackParam,
...
void UIScene_InGamePlayerOptionsMenu::handleCheckboxToggled(
    F64  controlId,
    bool selected
) {
    switch ((int)controlId) {
