...
UIScene_CraftingMenu::UIScene_CraftingMenu(
    int      iPad,
    void*    _initData,
    UILayer* parentLayer
)
: UIScene(iPad, parentLayer) {
    ...
    m_slotListIngredientsLayout.addSlots(
        CRAFTING_INGREDIENTS_LAYOUT_START,
    ...
    m_slotListCraftingHSlots.addSlots(
        CRAFTING_H_SLOT_START,
...
void UIScene_CraftingMenu::handleTouchInput(
    unsigned int iPad,
    S32          x,
    S32          y,
    int          iId,
...
void UIScene_CraftingMenu::handleTouchBoxRebuild() {
    addTimer(
        GAME_CRAFTING_TOUCHUPDATE_TIMER_ID,
...
void UIScene_CraftingMenu::handleInput(
    int   iPad,
    int   key,
    bool  repeat,
    bool  pressed,
...
void UIScene_CraftingMenu::setCraftHSlotItem(
    int                           iPad,
    int                           iIndex,
...
void UIScene_CraftingMenu::setCraftVSlotItem(
    int                           iPad,
    int                           iIndex,
    std::shared_ptr<ItemInstance> item,
    unsigned int                  uiAlpha
...
void UIScene_CraftingMenu::setIngredientDescriptionRedBox(
    int  index,
    bool show
) {
...
void UIScene_CraftingMenu::setIngredientDescriptionText(
    int     index,
    LPCWSTR text
) {
