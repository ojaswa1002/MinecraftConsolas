...
#include "platform/ui/all_platforms/IUIScene_CraftingMenu.h"
...
protected:
    ...
    virtual void setCraftHSlotItem(
        int                           iPad,
        int                           iIndex,
        std::shared_ptr<ItemInstance> item,
        unsigned int                  uiAlpha
    );
    virtual void setCraftVSlotItem(
        int                           iPad,
        int                           iIndex,
        std::shared_ptr<ItemInstance> item,
        unsigned int                  uiAlpha
    ...
    virtual void
    setCraftingOutputSlotItem(int iPad, std::shared_ptr<ItemInstance> item);
    virtual void setCraftingOutputSlotRedBox(bool show);
    virtual void setIngredientSlotItem(
        int                           iPad,
        int                           index,
        std::shared_ptr<ItemInstance> item
    );
