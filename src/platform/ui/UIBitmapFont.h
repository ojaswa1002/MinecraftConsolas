...
public:
    ...
    virtual IggyGlyphMetrics*
                   GetGlyphMetrics(S32 glyph, IggyGlyphMetrics* metrics)  = 0;
    ...
    virtual rrbool
    GetGlyphBitmap(S32 glyph, F32 pixel_scale, IggyBitmapCharacter* bitmap) = 0;
    virtual void FreeGlyphBitmap(
        S32                  glyph,
        F32                  pixel_scale,
    ...
    static S32 RADLINK
    GetCodepointGlyph_Callback(void* user_context, U32 codepoint);
    ...
    static F32 RADLINK    GetKerningForGlyphPair_Callback(
           void* user_context,
           S32   first_glyph,
           S32   second_glyph
       );
    static rrbool RADLINK
    CanProvideBitmap_Callback(void* user_context, S32 glyph, F32 pixel_scale);
    static rrbool RADLINK GetGlyphBitmap_Callback(
        void*                user_context,
        S32                  glyph,
        F32                  pixel_scale,
        IggyBitmapCharacter* bitmap
    );
    static void RADLINK FreeGlyphBitmap_Callback(
        void*                user_context,
        S32                  glyph,
        F32                  pixel_scale,
        IggyBitmapCharacter* bitmap
...
public:
    ...
    virtual IggyGlyphMetrics*
                   GetGlyphMetrics(S32 glyph, IggyGlyphMetrics* metrics);
    ...
    virtual rrbool
    GetGlyphBitmap(S32 glyph, F32 pixel_scale, IggyBitmapCharacter* bitmap);
    virtual void
    FreeGlyphBitmap(S32 glyph, F32 pixel_scale, IggyBitmapCharacter* bitmap);
};
