...
UIComponent_TutorialPopup::UIComponent_TutorialPopup(
    int      iPad,
    void*    initData,
    UILayer* parentLayer
)
...
void UIComponent_TutorialPopup::handleReload() {
    ...
    value[0].boolval =
        (bool)((app.GetGameSettings(
                ...
                != 0)
               && !m_bContainerMenuVisible); // 4J - TomK - Offset for
                                             // splitscreen gamertag?
...
void UIComponent_TutorialPopup::handleTimerComplete(int id) {
    ...
    case TUTORIAL_POPUP_FADE_TIMER_ID:
        ...
        killTimer(id);
        app.DebugPrintf(
            "handleTimerComplete: setting TUTORIAL_POPUP_MOVE_SCENE_TIMER_ID\n"
        );
        addTimer(
...
void UIComponent_TutorialPopup::_SetDescription(
...
std::wstring UIComponent_TutorialPopup::_SetIcon(
    int     icon,
    int     iAuxVal,
    bool    isFoil,
    LPCWSTR desc
...
std::wstring
UIComponent_TutorialPopup::ParseDescription(int iPad, std::wstring& text) {
...
void UIComponent_TutorialPopup::UpdateInteractScenePosition(bool visible) {
    ...
    case C4JRender::VIEWPORT_TYPE_SPLIT_BOTTOM:
        ...
        break;
    default:
        // anim allowed for everything except the crafting 2x2 and 3x3, and the
        // creative menu
...
void UIComponent_TutorialPopup::customDraw(
    ...
    if (m_iconItem != NULL)
        customDrawSlotControl(
            ...
            m_iconItem,
            1.0f,
            m_iconItem->isFoil() || m_iconIsFoil,
            false
        );
}
