...
public:
    ...
    virtual void
    SetTooltipText(unsigned int iPad, unsigned int tooltip, int iTextID) = 0;
    virtual void SetEnableTooltips(unsigned int iPad, BOOL bVal)         = 0;
    virtual void
    ShowTooltip(unsigned int iPad, unsigned int tooltip, bool show) = 0;
    ...
    virtual void
    EnableTooltip(unsigned int iPad, unsigned int tooltip, bool enable) = 0;
    ...
    virtual void
    SetSelectedItem(unsigned int iPad, const std::wstring& name) = 0;
    ...
    virtual void
    ShowSavingMessage(unsigned int iPad, C4JStorage::ESavingMessage eVal) = 0;
