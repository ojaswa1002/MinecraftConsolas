...
void IUIScene_CreativeMenu::staticCtor() {
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_REGENERATION)
    )
    ITEM_AUX(
        Item::potion_Id,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_NIGHTVISION)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(0, 0, MASK_INVISIBILITY)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    // ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED,
    // MASK_WEAKNESS))
    ITEM_AUX(
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_NIGHTVISION)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, 0, MASK_INVISIBILITY)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    // ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_NIGHTVISION)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(0, MASK_EXTENDED, MASK_INVISIBILITY)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2EXTENDED, MASK_SPEED)
    )
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTHEALTH)
    )
    // ITEM_AUX(Item::potion_Id,MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_NIGHTVISION)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_EXTENDED, MASK_INVISIBILITY)
    ) // 4J- Moved here as there isn't a weak variant of this potion.
    ITEM_AUX(
        Item::potion_Id,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2EXTENDED, MASK_STRENGTH)
    )
    ITEM_AUX(
        Item::potion_Id,
    ...
    ITEM_AUX(
        Item::potion_Id,
        MACRO_MAKEPOTION_AUXVAL(MASK_SPLASH, MASK_LEVEL2, MASK_INSTANTDAMAGE)
    )
    ...
    specs[eCreativeInventoryTab_RedstoneAndTransport] = new TabSpec(
        L"RedstoneAndTransport",
        IDS_GROUPNAME_REDSTONE_AND_TRANSPORT,
        2,
        redAndTranGroup,
        0,
        NULL
...
void IUIScene_CreativeMenu::switchTab(ECreativeInventoryTabs tab) {
    ...
    updateScrollCurrentPage(
        m_tabPage[m_curTab] + 1,
        specs[m_curTab]->getPageCount()
    );

    specs[tab]->populateMenu(
        itemPickerMenu,
...
void IUIScene_CreativeMenu::TabSpec::populateMenu(
...
IUIScene_CreativeMenu::ItemPickerMenu::ItemPickerMenu(
    std::shared_ptr<SimpleContainer> smp,
...
IUIScene_CreativeMenu::GetSectionAndSlotInDirection(
...
bool IUIScene_CreativeMenu::handleValidKeyPress(
    int  iPad,
    int  buttonNum,
    BOOL quickKeyHeld
) {
...
void IUIScene_CreativeMenu::handleOutsideClicked(
    int  iPad,
    int  buttonNum,
    BOOL quickKeyHeld
) {
...
void IUIScene_CreativeMenu::handleSlotListClicked(
    ...
    if (instantPlace || eSection == eSectionInventoryCreativeUsing) {
        ...
        pMinecraft->localgameModes[getPad()]->handleCreativeModeItemAdd(
            newItem,
            currentIndex - (int)m_menu->slots->size() + 9
                + InventoryMenu::USE_ROW_SLOT_START
        );
