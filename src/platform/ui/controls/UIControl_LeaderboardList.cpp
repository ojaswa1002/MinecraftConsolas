...
void UIControl_LeaderboardList::clearList() {
    ...
    IggyResult    out = IggyPlayerCallMethodRS(
        ...
        &result,
        getIggyValuePath(),
        m_funcResetLeaderboard,
        0,
        NULL
    );
}

void UIControl_LeaderboardList::setupTitles(
    const std::wstring& rank,
...
void UIControl_LeaderboardList::initLeaderboard(
    int iFirstFocus,
    int iTotalEntries,
    int iNumColumns
) {
