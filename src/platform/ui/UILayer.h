...
class UILayer {
private:
    std::vector<UIScene*> m_sceneStack; // Operates as a stack mainly, but we
                                        // may wish to iterate over all elements
    std::vector<UIScene*>
        m_components; // Other componenents in this scene that to do not conform
                      // the the user nav stack, and cannot take focus
