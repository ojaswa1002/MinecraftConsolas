...
void GameRuleDefinition::writeAttributes(
...
GameRuleDefinition*
GameRuleDefinition::addChild(ConsoleGameRules::EGameRuleType ruleType) {
#ifndef _CONTENT_PACKAGE
    wprintf(
        L"GameRuleDefinition: Attempted to add invalid child rule - %d\n",
        ruleType
    );
#endif
    return NULL;
...
void GameRuleDefinition::addAttribute(
...
#ifndef _CONTENT_PACKAGE
        wprintf(
            L"GameRuleDefinition: Adding parameter descriptionId=%ls\n",
...
#ifndef _CONTENT_PACKAGE
        wprintf(
            L"GameRuleDefinition: Adding parameter m_promptId=%ls\n",
            m_promptId.c_str()
        );
#endif
