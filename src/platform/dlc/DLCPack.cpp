...
void DLCPack::addParameter(
    ...
    case DLCManager::e_DLCParamType_PackId: {
        ...
        // 4J Stu - numbered using decimal to make it easier for artists/people
        // to number manually
...
bool DLCPack::getParameterAsUInt(
    DLCManager::EDLCParameterType type,
    unsigned int&                 param
) {
...
bool DLCPack::doesPackContainFile(
