...
//						 This stops us asking them to do things they have
// already done
// constraints			- A list of constraints which can be activated (as a
// whole).
//						 If they are active, then the constraints are removed
