...
#include "platform/gamerules/levelrules/ruledefinitions/LevelRuleset.h"
#include "platform/tutorial/constraints/AreaConstraint.h"
#include "platform/tutorial/constraints/ChangeStateConstraint.h"
#include "platform/tutorial/hints/AreaHint.h"
#include "platform/tutorial/tasks/AreaTask.h"
#include "platform/tutorial/tasks/ChoiceTask.h"
#include "platform/tutorial/tasks/CompleteUsingItemTask.h"
#include "platform/tutorial/tasks/ControllerTask.h"
#include "platform/tutorial/tasks/CraftTask.h"
#include "platform/tutorial/tasks/EffectChangedTask.h"
#include "platform/tutorial/tasks/FullTutorialActiveTask.h"
#include "platform/tutorial/tasks/InfoTask.h"
#include "platform/tutorial/tasks/PickupTask.h"
#include "platform/tutorial/tasks/ProcedureCompoundTask.h"
#include "platform/tutorial/tasks/ProgressFlagTask.h"
#include "platform/tutorial/tasks/StateChangeTask.h"
#include "platform/tutorial/tasks/UseItemTask.h"
#include "platform/tutorial/tasks/UseTileTask.h"
#include "platform/tutorial/tasks/XuiCraftingTask.h"
...
: Tutorial(iPad, true) {
    ...
    if (m_isTrial) {
        addTask(
            ...
            new ChoiceTask(
                this,
                IDS_TUTORIAL_TASK_OVERVIEW,
                IDS_TUTORIAL_PROMPT_START_TUTORIAL,
                true,
                ACTION_MENU_A,
                ACTION_MENU_B,
        ...
        if (getCompleted(eTutorial_Telemetry_Halfway)
            ...
            addTask(
                ...
                new ChoiceTask(
                    this,
                    IDS_TUTORIAL_NEW_FEATURES_CHOICE,
    ...
    addTask(
        ...
        new ControllerTask(
            this,
            IDS_TUTORIAL_TASK_LOOK,
            false,
            false,
            lookMappings,
            4,
            iLookCompletionMaskA,
            4,
            moveMappings,
            4
        )
    ...
    addTask(
        ...
        new ControllerTask(
            this,
            IDS_TUTORIAL_TASK_SCROLL,
            false,
            false,
            scrollMappings,
            2,
            iScrollCompletionMaskA,
            2
        )
    );
    ...
    addTask(
        ...
        new InfoTask(
            this,
            IDS_TUTORIAL_TASK_FOOD_BAR_DEPLETE,
            IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
            true,
            ACTION_MENU_A
        )
    ...
    addTask(
        ...
        new InfoTask(
            this,
            IDS_TUTORIAL_TASK_FOOD_BAR_HEAL,
            IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
            true,
            ACTION_MENU_A
        )
    ...
    addTask(
        ...
        new InfoTask(
            this,
            IDS_TUTORIAL_TASK_FOOD_BAR_FEED,
            IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
            true,
            ACTION_MENU_A
        )
    ...
    addTask(
        e_Tutorial_State_Gameplay,
        new CompleteUsingItemTask(
            this,
            IDS_TUTORIAL_TASK_FOOD_BAR_EAT_STEAK,
            foodItems,
            15,
            true
        )
    ...
    addTask(
        ...
        new ProgressFlagTask(
            ...
            ProgressFlagTask::e_Progress_Set_Flag,
            this
        )
    );
    addTask(
    ...
    addTask(
        ...
        new UseTileTask(
            Tile::workBench_Id,
            this,
            IDS_TUTORIAL_TASK_OPEN_WORKBENCH,
            false
        )
    );
    ...
    addTask(
        e_Tutorial_State_Gameplay,
        new UseItemTask(Item::door_wood->id, this, IDS_TUTORIAL_TASK_PLACE_DOOR)
    );
    addTask(
        e_Tutorial_State_Gameplay,
        new CraftTask(
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            ...
            areaConstraints->push_back(new AreaConstraint(
                IDS_TUTORIAL_CONSTRAINT_TUTORIAL_AREA,
                area->x0,
                area->y0,
                area->z0,
                area->x1,
    ...
    finalTask->AddTask(new InfoTask(
        this,
        IDS_TUTORIAL_FEATURES_OUTSIDE_THIS_AREA,
        IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
        true,
        ACTION_MENU_A
    ));
    finalTask->AddTask(new InfoTask(
        this,
        IDS_TUTORIAL_COMPLETED_EXPLORE,
        IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
        true,
        ACTION_MENU_A
    ));
    ...
    addTask(
        e_Tutorial_State_Inventory_Menu,
        new InfoTask(this, IDS_TUTORIAL_TASK_INV_EXIT, -1, false, ACTION_MENU_B)
    );
    ...
    addTask(
        ...
        new ProgressFlagTask(
            &m_progressFlags,
            FULL_TUTORIAL_PROGRESS_2_X_2_Crafting,
            ProgressFlagTask::e_Progress_Flag_On,
            this
        )
    );
    ...
    workbenchCompound->AddTask(new XuiCraftingTask(
        this,
    ...
    workbenchCompound->AddTask(new CraftTask(
        Tile::workBench_Id,
        -1,
        1,
        this,
    ...
    shovelCompound->AddTask(new CraftTask(
        shovelItems,
        shovelAuxVals,
        5,
        1,
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            addHint(
                e_Tutorial_State_Gameplay,
                new AreaHint(
                    e_Tutorial_Hint_Always_On,
                    this,
                    e_Tutorial_State_Gameplay,
                    e_Tutorial_State_Riding_Minecart,
                    IDS_TUTORIAL_HINT_MINECART,
                    area->x0,
                    area->y0,
                    area->z0,
                    area->x1,
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_CREATIVE_MODE,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new ControllerTask(
                    this,
                    IDS_TUTORIAL_TASK_OPEN_CREATIVE_INVENTORY,
                    false,
                    false,
                    crftMappings,
                    1
            ...
            if (exitArea != NULL) {
                ...
                creativeFinalTask->AddTask(new AreaTask(
                    ...
                    AreaTask::eAreaTaskCompletion_CompleteOnConstraintsSatisfied
                ));
            }
        ...
        if (area != NULL) {
            ...
            addTask(
                ...
                new ChoiceTask(
                    ...
                    IDS_TUTORIAL_PROMPT_BREWING_OVERVIEW,
                    true,
                    ACTION_MENU_A,
                    ACTION_MENU_B,
                    e_Tutorial_Completion_Complete_State_Gameplay_Constraints,
            ...
            ProcedureCompoundTask* fillWaterBottleTask =
                new ProcedureCompoundTask(this);
            fillWaterBottleTask->AddTask(new PickupTask(
                Item::glassBottle_Id,
                1,
                -1,
                this,
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_SEEDS,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_FARMLAND,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_WHEAT,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_PUMPKIN_AND_MELON,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_CACTUS,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_BONEMEAL,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_FARMING_COMPLETE,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_BREEDING_FEED,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_BREEDING_BABY,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_BREEDING_FOLLOW,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_BREEDING_COMPLETE,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
    ...
    if (app.getGameRuleDefinitions() != NULL) {
        ...
        if (area != NULL) {
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_GOLEM_PUMPKIN,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
            ...
            addTask(
                ...
                new InfoTask(
                    this,
                    IDS_TUTORIAL_TASK_GOLEM_IRON_VILLAGE,
                    IDS_TUTORIAL_PROMPT_PRESS_A_TO_CONTINUE,
                    true,
                    ACTION_MENU_A
                )
