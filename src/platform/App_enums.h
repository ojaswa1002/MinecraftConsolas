...
enum eXuiAction {
    ...
    eAppAction_TexturePackRequired, // when the user has joined from invite, but
                                    // doesn't have the texture pack
...
enum eMinecraftColour {
    ...
    // , g: aa, b: 0, i: 2 eHTMLColor_3 = 0x109e9e, // Changed by request of
    // Dave //0x00aaaa, //r:0 , g: aa, b: aa, i: 3 eHTMLColor_4 = 0xaa0000,
    // //r:aa , g: 0, b: 0, i: 4 eHTMLColor_5 = 0xaa00aa, //r:aa , g: 0, b: aa,
    // i: 5 eHTMLColor_6 = 0xffaa00, //r:ff , g: aa, b: 0, i: 6 eHTMLColor_7 =
    // 0xaaaaaa, //r:aa , g: aa, b: aa, i: 7 eHTMLColor_8 = 0x555555, //r:55 ,
    // g: 55, b: 55, i: 8 eHTMLColor_9 = 0x5555ff, //r:55 , g: 55, b: ff, i: 9
