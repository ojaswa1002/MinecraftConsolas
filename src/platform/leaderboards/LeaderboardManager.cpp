...
bool LeaderboardManager::ReadStats_Friends(
    LeaderboardReadListener* listener,
    int                      difficulty,
    EStatsType               type,
    PlayerUID                myUID,
...
bool LeaderboardManager::ReadStats_MyScore(
    LeaderboardReadListener* listener,
    int                      difficulty,
    EStatsType               type,
    PlayerUID                myUID,
...
bool LeaderboardManager::ReadStats_TopRank(
    LeaderboardReadListener* listener,
    int                      difficulty,
    EStatsType               type,
    unsigned int             startIndex,
...
bool DebugReadListener::OnStatsReadComplete(
    LeaderboardManager::eStatsReturn success,
    int                              numResults,
    LeaderboardManager::ViewOut      results
) {
    app.DebugPrintf(
        "[DebugReadListener] OnStatsReadComplete, %s:\n",
