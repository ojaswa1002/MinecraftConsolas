...
#define MAKE_SLOTDISPLAY_DATA_BITMASK(                                         \
    uiUserIndex,                                                               \
    uiAlpha,                                                                   \
    bDecorations,                                                              \
    uiCount,                                                                   \
...
// #define GET_SLOTDISPLAY_AUXVAL_FROM_DATA_BITMASK(uiBitmask)		((((unsigned
// long)uiBitmask)>>12)&0x7FF)
