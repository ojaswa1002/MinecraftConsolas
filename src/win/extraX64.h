...
#include "orbis/Orbis_PlayerUID.h"
#include "orbis/network/SQRNetworkManager_Orbis.h"
...
#include "ps3/source files/PS3_PlayerUID.h"
#include "ps3/source files/network/SQRNetworkManager_PS3.h"
...
#include "psvita/source files/PSVita_PlayerUID.h"
#include "psvita/source files/network/SQRNetworkManager_AdHoc_Vita.h"
#include "psvita/source files/network/SQRNetworkManager_Vita.h"
...
public:
    ...
    QNET_STATE   GetState();
    bool         IsHost();
    HRESULT      JoinGameFromInviteInfo(
             DWORD              dwUserIndex,
             DWORD              dwUserMask,
