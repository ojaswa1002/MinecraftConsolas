...
public:
    ...
    void putLong(wchar_t* name, std::int64_t value) {
    ...
    void putString(wchar_t* name, const std::wstring& value) {
    ...
    bool contains(wchar_t* name) { return tags.find(name) != tags.end(); }
    ...
    std::int64_t getLong(wchar_t* name) {
        if (tags.find(name) == tags.end()) return (std::int64_t)0;
    ...
    std::wstring getString(wchar_t* name) {
    ...
    bool getBoolean(wchar_t* string) { return getByte(string) != 0; }
