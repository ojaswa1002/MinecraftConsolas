...
#include "commands/common/DefaultGameModeCommand.h"
#include "commands/common/EnchantItemCommand.h"
#include "commands/common/ExperienceCommand.h"
#include "commands/common/GameModeCommand.h"
#include "commands/common/GiveItemCommand.h"
#include "commands/common/KillCommand.h"
#include "commands/common/TimeCommand.h"
#include "commands/common/ToggleDownfallCommand.h"
...
void ServerCommandDispatcher::logAdminCommand(
    ...
    if ((type & LOGTYPE_DONT_SHOW_TO_SELF) != LOGTYPE_DONT_SHOW_TO_SELF) {
        source
            ->sendMessage(message, messageType, customData, additionalMessage);
    }
}
