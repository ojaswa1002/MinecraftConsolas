...
public:
    ...
    virtual bool
    openContainer(std::shared_ptr<Container> container); // 4J added bool return
    virtual bool openFurnace(
        std::shared_ptr<FurnaceTileEntity> furnace
    ); // 4J added bool return
    virtual bool
    openTrap(std::shared_ptr<DispenserTileEntity> trap); // 4J added bool return
    virtual bool openBrewingStand(
        std::shared_ptr<BrewingStandTileEntity> brewingStand
    ); // 4J added bool return
    virtual bool
    openTrading(std::shared_ptr<Merchant> traderTarget); // 4J added bool return
    ...
    virtual void
    setContainerData(AbstractContainerMenu* container, int id, int value);
...
public:
    static int
        getFlagIndexForChunk(const ChunkPos& pos, int dimension); // 4J - added
