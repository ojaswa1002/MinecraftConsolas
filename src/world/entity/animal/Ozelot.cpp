...
#include "world/entity/ai/goal/OcelotSitOnTileGoal.h"
#include "world/entity/ai/goal/OzelotAttackGoal.h"
#include "world/entity/ai/goal/RandomStrollGoal.h"
#include "world/entity/ai/goal/SitGoal.h"
#include "world/entity/ai/goal/TemptGoal.h"
...
Ozelot::Ozelot(Level* level) : TamableAnimal(level) {
    ...
    goalSelector.addGoal(
        4,
        new AvoidPlayerGoal(this, typeid(Player), 16, WALK_SPEED, SPRINT_SPEED)
    );
    ...
    targetSelector.addGoal(
        1,
        new NonTameRandomTargetGoal(this, typeid(Chicken), 14, 750, false)
    );
}
...
Ozelot::getBreedOffspring(std::shared_ptr<AgableMob> target) {
...
void Ozelot::setCatType(int type) { entityData->set(DATA_TYPE_ID, (byte)type); }
