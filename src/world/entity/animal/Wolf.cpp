...
#include "world/entity/ai/goal/BegGoal.h"
#include "world/entity/ai/goal/BreedGoal.h"
#include "world/entity/ai/goal/FloatGoal.h"
#include "world/entity/ai/goal/FollowOwnerGoal.h"
#include "world/entity/ai/goal/GoalSelector.h"
#include "world/entity/ai/goal/LeapAtTargetGoal.h"
...
#include "world/entity/ai/goal/SitGoal.h"
#include "world/entity/ai/goal/target/HurtByTargetGoal.h"
#include "world/entity/ai/goal/target/NonTameRandomTargetGoal.h"
#include "world/entity/ai/goal/target/OwnerHurtByTargetGoal.h"
#include "world/entity/ai/goal/target/OwnerHurtTargetGoal.h"
...
Wolf::Wolf(Level* level) : TamableAnimal(level) {
    ...
    targetSelector.addGoal(
        4,
        new NonTameRandomTargetGoal(this, typeid(Sheep), 16, 200, false)
    );
}
...
void Wolf::defineSynchedData() {
    ...
    entityData->define(
        DATA_COLLAR_COLOR,
        (byte)ClothTile::getTileDataForItemAuxValue(DyePowderItem::RED)
    );
}
...
float Wolf::getHeadRollAngle(float a) {
    return (interestedAngleO + (interestedAngle - interestedAngleO) * a) * 0.15f
         * PI;
}
...
bool Wolf::hurt(DamageSource* source, int dmg) {
    ...
    if (sourceEntity != NULL
        && !(
            dynamic_pointer_cast<Player>(sourceEntity) != NULL
            || dynamic_pointer_cast<Arrow>(sourceEntity) != NULL
        )) {
...
Wolf::getBreedOffspring(std::shared_ptr<AgableMob> target) {
