...
Pig::Pig(Level* level) : Animal(level) {
    ...
    goalSelector.addGoal(
        2,
        controlGoal = new ControlledByPlayerGoal(this, 0.34f, walkSpeed)
    );
    goalSelector.addGoal(3, new BreedGoal(this, walkSpeed));
    goalSelector.addGoal(
        4,
        new TemptGoal(this, 0.3f, Item::carrotOnAStick_Id, false)
    );
    goalSelector.addGoal(
        4,
...
Pig::getBreedOffspring(std::shared_ptr<AgableMob> target) {
