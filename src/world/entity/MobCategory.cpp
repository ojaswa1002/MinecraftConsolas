...
void MobCategory::staticCtor() {
    ...
    waterCreature = new MobCategory(
        5,
        Material::water,
        true,
        eTYPE_WATERANIMAL,
        false,
        CONSOLE_SQUID_HARD_LIMIT
    );
    ...
    creature_chicken = new MobCategory(
        2,
        Material::air,
        true,
        eTYPE_CHICKEN,
...
MobCategory::MobCategory(
    int         maxVar,
    Material*   spawnPositionMaterial,
    bool        isFriendly,
    eINSTANCEOF eBase,
    bool        isSingleType,
    int         maxPerLevel
