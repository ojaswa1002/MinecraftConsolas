...
bool AbstractContainerMenu::clickMenuButton(
...
Slot* AbstractContainerMenu::getSlotFor(
...
void AbstractContainerMenu::loopClick(
    int                     slotIndex,
    int                     buttonNum,
    bool                    quickKeyHeld,
    std::shared_ptr<Player> player
...
bool AbstractContainerMenu::mayCombine(
    Slot*                         slot,
...
void AbstractContainerMenu::setItem(
    unsigned int                  slot,
    std::shared_ptr<ItemInstance> item
) {
...
void AbstractContainerMenu::setSynched(
    std::shared_ptr<Player> player,
    bool                    synched
) {
    if (synched) {
