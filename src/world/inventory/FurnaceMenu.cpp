...
FurnaceMenu::quickMoveStack(std::shared_ptr<Player> player, int slotIndex) {
...
#ifdef _EXTENDED_ACHIEVEMENTS
    if (charcoalUsed && (out != nullptr) && (buttonNum == 0 || buttonNum == 1)
        && clickType == CLICK_PICKUP && out->getItem()->id == Item::coal_Id
