...
float WeaponItem::getDestroySpeed(
...
UseAnim
WeaponItem::getUseAnimation(std::shared_ptr<ItemInstance> itemInstance) {
...
bool WeaponItem::isValidRepairItem(
