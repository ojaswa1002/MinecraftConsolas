...
void Item::staticCtor() {
    ...
    Item::helmet_diamond =
        (ArmorItem*)((new ArmorItem(
                          54,
                          ArmorItem::ArmorMaterial::DIAMOND,
                          3,
                          ArmorItem::SLOT_HEAD
                      ))
                         ->setBaseItemTypeAndMaterial(
    ...
    Item::flintAndSteel = (new FlintAndSteelItem(3))
    ...
    Item::apple_gold =
        (new GoldenAppleItem(
            ...
            ->setDescriptionId(
                IDS_ITEM_APPLE_GOLD
            ); //->setUseDescriptionId(IDS_DESC_GOLDENAPPLE);
...
HitResult* Item::getPlayerPOVHitResult(
    Level*                  level,
    std::shared_ptr<Player> player,
    bool                    alsoPickLiquid
) {
