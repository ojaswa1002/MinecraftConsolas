...
const Rarity*
EnchantedBookItem::getRarity(std::shared_ptr<ItemInstance> itemInstance) {
...
ListTag<CompoundTag>*
EnchantedBookItem::getEnchantments(std::shared_ptr<ItemInstance> item) {
    if (item->tag == NULL
...
void EnchantedBookItem::addEnchantment(
...
EnchantedBookItem::createForEnchantment(EnchantmentInstance* enchant) {
    std::shared_ptr<ItemInstance> item =
...
std::shared_ptr<ItemInstance>
EnchantedBookItem::createForRandomLoot(Random* random) {
...
WeighedTreasure* EnchantedBookItem::createForRandomTreasure(
    Random* random,
    int     minCount,
    int     maxCount,
    int     weight
