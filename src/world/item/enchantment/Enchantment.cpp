...
void Enchantment::staticCtor() {
    ...
    fireProtection = new ProtectionEnchantment(
        1,
        FREQ_UNCOMMON,
        ProtectionEnchantment::FIRE
    );
    fallProtection = new ProtectionEnchantment(
        2,
        FREQ_UNCOMMON,
    ...
    explosionProtection = new ProtectionEnchantment(
        3,
        FREQ_RARE,
        ProtectionEnchantment::EXPLOSION
    );
    projectileProtection = new ProtectionEnchantment(
        4,
        FREQ_UNCOMMON,
        ProtectionEnchantment::PROJECTILE
    );
...
: id(id),
  ...
  category(EnchantmentCategory::all) {
    _init(id);
}
...
std::wstring Enchantment::getFullname(int level, std::wstring& unformatted) {
    ...
    swprintf(
        ...
        256,
        L"%ls %ls",
        app.GetString(getDescriptionId()),
    ...
    swprintf(
        ...
        app.GetHTMLColour(eHTMLColor_f),
        unformatted.c_str()
    );
    return formatted;
}
