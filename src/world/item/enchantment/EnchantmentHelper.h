...
public:
    static int
    getEnchantmentLevel(int enchantmentId, std::shared_ptr<ItemInstance> piece);
    static std::unordered_map<int, int>*
                getEnchantments(std::shared_ptr<ItemInstance> item);
    static void setEnchantments(
        std::unordered_map<int, int>* enchantments,
        std::shared_ptr<ItemInstance> item
    );

    static int
    getEnchantmentLevel(int enchantmentId, ItemInstanceArray inventory);
...
public:
    ...
    getRandomItemWith(Enchantment* enchantment, std::shared_ptr<Mob> source);
