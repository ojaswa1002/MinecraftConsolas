...
void FoodRecipies::addRecipes(Recipes* r) {
    ...
    r->addShapedRecipy(
        new ItemInstance(Item::apple_gold, 1, 0), //
        L"ssscicig",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Item::seeds_melon), //
        L"scig",
        L"M", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Item::seeds_pumpkin, 4), //
        L"sctg",
        L"M", //
    ...
    r->addShapelessRecipy(
        new ItemInstance(Item::pumpkinPie), //
        L"tiig",
        Tile::pumpkin,
        Item::sugar,
        Item::egg,
    ...
    r->addShapedRecipy(
        new ItemInstance(Item::apple_gold, 1, 1), //
        L"sssctcig",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Item::carrotGolden, 1, 0), //
        L"ssscicig",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    r->addShapelessRecipy(
        new ItemInstance(Item::fermentedSpiderEye), //
        L"itig",
        Item::spiderEye,
        Tile::mushroom1,
        Item::sugar,
    ...
    r->addShapelessRecipy(
        new ItemInstance(Item::speckledMelon), //
        L"iig",
        Item::melon,
        Item::goldNugget,
        L'F'
    ...
    r->addShapelessRecipy(
        new ItemInstance(Item::blazePowder, 2), //
        L"ig",
        Item::blazeRod,
        L'F'
    );
    ...
    r->addShapelessRecipy(
        new ItemInstance(Item::magmaCream), //
        L"iig",
        Item::blazePowder,
        Item::slimeBall,
        L'F'
