...
void StructureRecipies::addRecipes(Recipes* r) {
    r->addShapedRecipy(
        new ItemInstance(Tile::sandStone), //
        L"ssctg",
        L"##", //
        L"##", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::sandStone, 4, SandStoneTile::TYPE_SMOOTHSIDE), //
        L"ssczg",
        L"##", //
        L"##", //
    ...
    // fullscreen.
    r->addShapedRecipy(
        new ItemInstance(Tile::workBench), //
        L"ssctg",
        L"##", //
        L"##", //
    ...
    r->addShapedRecipy(
        new ItemInstance((Tile*)Tile::chest), //
        L"sssctg",
        L"###", //
        L"# #", //
        L"###", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::enderChest), //
        L"sssctcig",
        L"###", //
        L"#E#", //
        L"###", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::stoneBrickSmooth, 4), //
        L"ssctg",
        L"##", //
        L"##", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::thinGlass, 16), //
        L"ssctg",
        L"###", //
        L"###", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::netherBrick, 1), //
        L"sscig",
        L"NN", //
        L"NN", //
    ...
    r->addShapedRecipy(
        new ItemInstance(Tile::redstoneLight, 1), //
        L"ssscictg",
        L" R ", //
        L"RGR", //
        L" R ", //
