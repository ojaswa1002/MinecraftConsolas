...
#include "world/level/tile/HalfSlabTile.h"
...
Recipes::Recipes() {
    ...
    addShapedRecipy(
        new ItemInstance(Tile::wood, 4, 0), //
        L"sczg",
        L"#", //

        L'#',
        new ItemInstance(Tile::treeTrunk, 1, 0),
        L'S'
    );
    ...
    addShapedRecipy(
        ...
        L'#',
        new ItemInstance(Tile::treeTrunk, 1, TreeTile::DARK_TRUNK),
        L'S'
    );
    ...
    addShapedRecipy(
        new ItemInstance(Tile::enchantTable, 1), //
        L"sssctcicig",
        L" B ", //
        L"D#D", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::ladder, 3), //
        L"ssscig",
        L"# #", //
        L"###", //
        L"# #", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::fenceGate, 1), //
        L"sscictg",
        L"#W#", //
        L"#W#", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::netherFence, 6), //
        L"ssctg",
        L"###", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::ironFence, 16), //
        L"sscig",
        L"###", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::door_wood, 1), //
        L"sssctg",
        L"##", //
        L"##", //
        L"##", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::door_iron, 1), //
        L"ssscig",
        L"##", //
        L"##", //
        L"##", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_wood, 4), //
        L"sssczg",
        L"#  ", //
        L"## ", //
        L"###", //
        ...
        L'#',
        new ItemInstance(Tile::wood, 1, 0),
        L'S'
    );

    addShapedRecipy(
        new ItemInstance(Tile::trapdoor, 2), //
        L"ssctg",
        L"###", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_stone, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_bricks, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_stoneBrickSmooth, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_netherBricks, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stairs_sandstone, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::woodStairsDark, 4), //
        L"sssczg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        ...
        L'#',
        new ItemInstance(Tile::wood, 1, TreeTile::JUNGLE_TRUNK),
        L'S'
    );

    addShapedRecipy(
        new ItemInstance(Tile::stairs_quartz, 4), //
        L"sssctg",
        L"#  ", //
        L"## ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::redBrick, 1), //
        L"sscig",
        L"##", //
        L"##", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::stoneSlabHalf, 6, StoneSlabTile::QUARTZ_SLAB), //
        L"sctg",
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::woodSlabHalf, 6, 0), //
        L"sczg",
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::goldenRail, 6), //
        L"ssscicicig",
        L"X X", //
        L"X#X", //
        L"XRX", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::detectorRail, 6), //
        L"ssscicictg",
        L"X X", //
        L"X#X", //
        L"XRX", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::minecart_chest, 1), //
        L"ssctcig",
        L"A", //
        L"B", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::minecart_furnace, 1), //
        L"ssctcig",
        L"A", //
        L"B", //
    ...
    addShapedRecipy(
        new ItemInstance((Item*)Item::fishingRod, 1), //
        L"ssscicig",
        L"  #", //
        L" #X", //
        L"# X", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::carrotOnAStick, 1), //
        L"sscicig",
        L"# ", //
        L" X", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::flintAndSteel, 1), //
        L"sscicig",
        L"A ", //
        L" B", //
    ...
    // display
    addShapedRecipy(
        new ItemInstance((Item*)Item::bow, 1), //
        L"ssscicig",
        L" #X", //
        L"# X", //
        L" #X", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::bucket_empty, 1), //
        L"sscig",
        L"# #", //
        L" # ", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::glassBottle, 3), //
        L"ssctg",
        L"# #", //
        L" # ", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::flowerPot, 1), //
        L"sscig",
        L"# #", //
        L" # ", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::lightGem, 1), //
        L"sscig",
        L"##", //
        L"##", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::tripWireSource, 2), //
        L"sssctcicig",
        L"I", //
        L"S", //
        L"#", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::notGate_on, 1), //
        L"sscicig",
        L"X", //
        L"#", //
    ...
    addShapelessRecipy(
        new ItemInstance(Item::eyeOfEnder, 1), //
        L"iig",
        Item::enderPearl,
        Item::blazePowder,
        L'T'
    ...
    addShapelessRecipy(
        new ItemInstance(Item::fireball, 3), //
        L"iiig",
        Item::sulphur,
        Item::blazePowder,
        Item::coal,
    ...
    addShapedRecipy(
        new ItemInstance(Item::compass, 1), //
        L"ssscicig",
        L" # ", //
        L"#X#", //
        L" # ", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::button, 1), //
        L"sctg",
        L"#", //
        // L"#", //
        L'#',
    ...
    addShapedRecipy(
        new ItemInstance(Tile::button_wood, 1), //
        L"sctg",
        L"#", //
        // L"#", //
        L'#',
    ...
    addShapedRecipy(
        new ItemInstance(Tile::pressurePlate_wood, 1), //
        L"sctg",
        L"##", //
        L'#',
        Tile::wood,
    ...
    addShapedRecipy(
        new ItemInstance(Tile::pressurePlate_stone, 1), //
        L"sctg",
        L"##", //
        L'#',
        Tile::rock,
    ...
    addShapedRecipy(
        new ItemInstance(Tile::dispenser, 1), //
        L"sssctcicig",
        L"###", //
        L"#X#", //
        L"#R#", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::cauldron, 1), //
        L"ssscig",
        L"# #", //
        L"# #", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::brewingStand, 1), //
        L"ssctcig",
        L" B ", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::litPumpkin, 1), //
        L"ssctctg",
        L"A", //
        L"B", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::recordPlayer, 1), //
        L"sssctcig",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::musicBlock, 1), //
        L"sssctcig",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Tile::bookshelf, 1), //
        L"sssctcig",
        L"###", //
        L"XXX", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::painting, 1), //
        L"ssscictg",
        L"###", //
        L"#X#", //
        L"###", //
    ...
    addShapedRecipy(
        new ItemInstance(Item::goldNugget, 9), //
        L"scig",
        L"#", //
        L'#',
        Item::goldIngot,
    ...
    addShapedRecipy(
        new ItemInstance((Tile*)Tile::pistonBase, 1), //
        L"sssctcicictg",
        L"TTT", //
        L"#X#", //
        L"#R#", //
    ...
    addShapedRecipy(
        new ItemInstance((Tile*)Tile::pistonStickyBase, 1), //
        L"sscictg",
        L"S", //
        L"P", //
...
void Recipes::addShapelessRecipy(ItemInstance* result, ...) {
    ...
    for (int i = 0; szTypes[i] != L'\0'; ++i) {
        ...
        case L'z':
            pItemInstance = va_arg(vl, ItemInstance*);
            // 4J-PB - original code copies the item instance, copy the pointer
            // isnt the same...
            // TODO
