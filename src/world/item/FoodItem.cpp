...
void FoodItem::addEatEffect(
    ...
    if (!level->isClientSide && effectId > 0
        ...
        player->addEffect(new MobEffectInstance(
            effectId,
            effectDurationSeconds * SharedConstants::TICKS_PER_SECOND,
            effectAmplifier
        ));
    }
}
...
FoodItem* FoodItem::setEatEffect(
    int   id,
    int   durationInSecods,
    int   amplifier,
