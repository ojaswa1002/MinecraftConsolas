...
void TheEndLevelRandomLevelSource::prepareHeights(
    int        xOffs,
    int        zOffs,
    byteArray  blocks,
    BiomeArray biomes
...
void TheEndLevelRandomLevelSource::buildSurfaces(
    int        xOffs,
    int        zOffs,
    byteArray  blocks,
    BiomeArray biomes
...
doubleArray TheEndLevelRandomLevelSource::getHeights(
    doubleArray buffer,
    int         x,
    int         y,
    int         z,
...
void TheEndLevelRandomLevelSource::calcWaterDepths(
    ChunkSource* parent,
    int          xt,
    int          zt
) {
...
void TheEndLevelRandomLevelSource::postProcess(
    ChunkSource* parent,
    int          xt,
    int          zt
) {
    ...
    biome->decorate(
        ...
        xo,
        zo
    ); // 4J - passing pprandom rather than level->random here to make this
       // consistent with our parallel world generation
...
bool TheEndLevelRandomLevelSource::save(
    bool              force,
