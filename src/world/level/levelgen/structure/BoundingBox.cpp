...
BoundingBox* BoundingBox::orientBox(
    int footX,
    int footY,
    int footZ,
    int offX,
...
bool BoundingBox::intersects(BoundingBox* other) {
    return !(
        this->x1 < other->x0 || this->x0 > other->x1 || this->z1 < other->z0
        || this->z0 > other->z1 || this->y1 < other->y0 || this->y0 > other->y1
    );
}

bool BoundingBox::intersects(int x0, int y0, int z0, int x1, int y1, int z1) {
    return !(
        this->x1 < x0 || this->x0 > x1 || this->z1 < z0 || this->z0 > z1
