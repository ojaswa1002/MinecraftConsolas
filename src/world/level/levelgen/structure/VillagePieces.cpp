...
VillagePieces::PieceWeight::PieceWeight(
    VillagePieces::EPieceClass pieceClass,
    int                        weight,
    int                        maxPlaceCount
)
: weight(weight) {
...
std::list<VillagePieces::PieceWeight*>*
VillagePieces::createPieceSet(Random* random, int villageSize) {
    std::list<PieceWeight*>* newPieces = new std::list<PieceWeight*>;

    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_SimpleHouse,
        4,
        Mth::nextInt(random, 2 + villageSize, 4 + villageSize * 2)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_SmallTemple,
        20,
        Mth::nextInt(random, 0 + villageSize, 1 + villageSize)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_BookHouse,
        20,
        Mth::nextInt(random, 0 + villageSize, 2 + villageSize)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_SmallHut,
        3,
        Mth::nextInt(random, 2 + villageSize, 5 + villageSize * 3)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_PigHouse,
        15,
        Mth::nextInt(random, 0 + villageSize, 2 + villageSize)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_DoubleFarmland,
        3,
        Mth::nextInt(random, 1 + villageSize, 4 + villageSize)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_Farmland,
        3,
        Mth::nextInt(random, 2 + villageSize, 4 + villageSize * 2)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_Smithy,
        15,
        Mth::nextInt(random, 0, 1 + villageSize)
    ));
    newPieces->push_back(new PieceWeight(
        VillagePieces::EPieceClass_TwoRoomHouse,
        8,
...
VillagePieces::VillagePiece* VillagePieces::findAndCreatePieceFactory(
    ...
    VillagePieces::PieceWeight* piece,
    ...
    if (pieceClass == VillagePieces::EPieceClass_SimpleHouse) {
        ...
        villagePiece = BookHouse::createPiece(
            startPiece,
            pieces,
            random,
            footX,
        ...
        villagePiece = SmallHut::createPiece(
            startPiece,
            pieces,
            random,
            footX,
        ...
        villagePiece = PigHouse::createPiece(
            startPiece,
            pieces,
            random,
            footX,
        ...
        villagePiece = Farmland::createPiece(
            startPiece,
            pieces,
            random,
            footX,
        ...
        villagePiece = Smithy::createPiece(
            startPiece,
            pieces,
            random,
            footX,
...
bool VillagePieces::VillagePiece::isOkBox(
    BoundingBox* box,
...
bool VillagePieces::StraightRoad::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool VillagePieces::SimpleHouse::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    if (getBlock(level, 2, 0, -1, chunkBB) == 0
        ...
        placeBlock(
            ...
            getOrientationData(Tile::stairs_stone_Id, 3),
            2,
            0,
            -1,
            chunkBB
...
bool VillagePieces::SmallTemple::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    placeBlock(
        level,
        Tile::stairs_stone_Id,
        getOrientationData(Tile::stairs_stone_Id, 1),
        1,
        2,
        7,
        chunkBB
    ...
    placeBlock(
        level,
        Tile::stairs_stone_Id,
        getOrientationData(Tile::stairs_stone_Id, 0),
        3,
        2,
        7,
        chunkBB
...
bool VillagePieces::BookHouse::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    placeBlock(
        level,
        Tile::stairs_wood_Id,
        getOrientationData(Tile::stairs_wood_Id, 0),
        7,
        1,
        3,
        chunkBB
...
bool VillagePieces::SmallHut::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool VillagePieces::PigHouse::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    placeBlock(
        level,
        Tile::stairs_wood_Id,
        getOrientationData(Tile::stairs_wood_Id, 3),
        2,
        1,
        4,
        chunkBB
    ...
    placeBlock(
        level,
        Tile::stairs_wood_Id,
        getOrientationData(Tile::stairs_wood_Id, 1),
        1,
        1,
        3,
        chunkBB
...
bool VillagePieces::TwoRoomHouse::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool VillagePieces::Smithy::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool VillagePieces::LightPost::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
