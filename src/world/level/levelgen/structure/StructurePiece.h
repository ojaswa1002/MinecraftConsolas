...
public:
    ...
    public:
        virtual void
        next(Random* random, int worldX, int worldY, int worldZ, bool isEdge) {}
...
public:
    ...
    virtual bool
    postProcess(Level* level, Random* random, BoundingBox* chunkBB) = 0;
...
public:
    ...
    findCollisionPiece(std::list<StructurePiece*>* pieces, BoundingBox* box);
...
public:
     ...
     */
    virtual int
    getBlock(Level* level, int x, int y, int z, BoundingBox* chunkBB);
    virtual void generateAirBox(
        Level*       level,
        BoundingBox* chunkBB,
        int          x0,
        int          y0,
    ...
    virtual void maybeGenerateBlock(
        Level*       level,
        BoundingBox* chunkBB,
        Random*      random,
        float        probability,
    ...
    virtual void generateUpperHalfSphere(
        Level*       level,
        BoundingBox* chunkBB,
        int          x0,
        int          y0,
    ...
    virtual void generateAirColumnUp(
        Level*       level,
        int          x,
        int          startY,
        int          z,
