...
StrongholdPieces::PieceWeight::PieceWeight(
...
StrongholdPieces::StrongholdPiece* StrongholdPieces::findAndCreatePieceFactory(
    ...
    if (pieceClass == EPieceClass_Straight) {
        strongholdPiece = Straight::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = PrisonHall::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = LeftTurn::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = RightTurn::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = StairsDown::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = Library::createPiece(
            pieces,
            random,
            footX,
            footY,
        ...
        strongholdPiece = PortalRoom::createPiece(
            pieces,
            random,
            footX,
            footY,
...
void StrongholdPieces::StrongholdPiece::generateSmallDoor(
    ...
    Random*                                          random,
    BoundingBox*                                     chunkBB,
    StrongholdPieces::StrongholdPiece::SmallDoorType doorType,
    int                                              footX,
    int                                              footY,
    int                                              footZ
) {
    ...
    case IRON_DOOR:
        ...
        placeBlock(
            level,
            Tile::button_stone_Id,
            getOrientationData(Tile::button_stone_Id, 4),
            footX + 2,
            footY + 1,
            footZ + 1,
            chunkBB
        ...
        placeBlock(
            level,
            Tile::button_stone_Id,
            getOrientationData(Tile::button_stone_Id, 3),
            footX + 2,
            footY + 1,
            footZ - 1,
            chunkBB
...
bool StrongholdPieces::StrongholdPiece::isOkBox(
    BoundingBox* box,
...
StrongholdPieces::FillerCorridor::FillerCorridor(
    int          genDepth,
    Random*      random,
...
bool StrongholdPieces::FillerCorridor::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::StairsDown::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
void StrongholdPieces::Straight::addChildren(
    StructurePiece*             startPiece,
    std::list<StructurePiece*>* pieces,
    Random*                     random
) {
...
bool StrongholdPieces::Straight::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::ChestCorridor::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::StraightStairsDown::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::LeftTurn::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::RightTurn::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::RoomCrossing::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    case 2: {
        ...
        placeBlock(
            level,
            Tile::ladder_Id,
            getOrientationData(Tile::ladder_Id, Facing::WEST),
            9,
            1,
            3,
            chunkBB
...
bool StrongholdPieces::PrisonHall::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    placeBlock(
        level,
        Tile::door_iron_Id,
        getOrientationData(Tile::door_iron_Id, 3),
        4,
        1,
        2,
        chunkBB
...
bool StrongholdPieces::Library::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
...
bool StrongholdPieces::PortalRoom::postProcess(
    Level*       level,
    Random*      random,
    BoundingBox* chunkBB
) {
    ...
    placeBlock(
        ...
        north
            + ((random->nextFloat() > 0.9f) ? TheEndPortalFrameTile::EYE_BIT
                                            : 0),
        4,
        3,
        8,
