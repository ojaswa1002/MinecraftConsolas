...
public:
    ...
    public:
        ...
        PieceWeight(
            ...
            int         weight,
            int         maxPlaceCount
        ); // 4J - EPieceClass was Class<? extends VillagePiece>
        bool doPlace(int depth);
        bool isValid();
    };

    static std::list<PieceWeight*>*
    createPieceSet(Random* random, int villageSize); // 4J - was ArrayList
...
public:
    ...
    public:
        static SimpleHouse* createPiece(
            StartPiece*                 startPiece,
            std::list<StructurePiece*>* pieces,
            Random*                     random,
            int                         footX,
...
public:
    ...
    public:
        ...
        static SmallTemple* createPiece(
            StartPiece*                 startPiece,
            std::list<StructurePiece*>* pieces,
            Random*                     random,
            int                         footX,
...
public:
    ...
    public:
        ...
        static TwoRoomHouse* createPiece(
            StartPiece*                 startPiece,
            std::list<StructurePiece*>* pieces,
            Random*                     random,
            int                         footX,
