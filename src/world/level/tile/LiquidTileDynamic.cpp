...
bool LiquidTileDynamic::isPathfindable(
    LevelSource* level,
    int          x,
    int          y,
    int          z
...
void LiquidTileDynamic::iterativeTick(
    Level*  level,
    int     x,
    int     y,
    int     z,
...
void LiquidTileDynamic::mainTick(
    Level*  level,
    int     x,
    int     y,
    int     z,
...
void LiquidTileDynamic::trySpreadTo(
    Level* level,
    int    x,
    int    y,
    int    z,
...
int LiquidTileDynamic::getSlopeDistance(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool LiquidTileDynamic::isWaterBlocking(Level* level, int x, int y, int z) {
    ...
    if (t == Tile::door_wood_Id || t == Tile::door_iron_Id || t == Tile::sign_Id
        || t == Tile::ladder_Id || t == Tile::reeds_Id) {
        return true;
    }
    if (t == 0) return false;
...
int LiquidTileDynamic::getHighest(
    Level* level,
    int    x,
    int    y,
    int    z,
