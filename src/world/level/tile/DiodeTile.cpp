...
const double DiodeTile::DELAY_RENDER_OFFSETS[4] =
...
bool DiodeTile::shouldRenderFace(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
