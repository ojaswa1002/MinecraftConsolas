...
int TripWireSourceTile::getPlacedOnFaceDataValue(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireSourceTile::finalizePlacement(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireSourceTile::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireSourceTile::playSound(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireSourceTile::notifyNeighbors(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireSourceTile::updateShape(
    LevelSource*                level,
    int                         x,
    int                         y,
    int                         z,
...
void TripWireSourceTile::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool TripWireSourceTile::getSignal(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
...
bool TripWireSourceTile::getDirectSignal(
    Level* level,
    int    x,
    int    y,
    int    z,
