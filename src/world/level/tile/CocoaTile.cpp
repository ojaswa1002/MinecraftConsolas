...
const std::wstring CocoaTile::TEXTURE_AGES[] =
    {L"cocoa_0", L"cocoa_1", L"cocoa_2"};
...
int CocoaTile::getPlacedOnFaceDataValue(
    Level* level,
    int    x,
    int    y,
    int    z,
