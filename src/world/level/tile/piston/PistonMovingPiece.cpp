...
: EntityTile(id, Material::piston, isSolidRender()) {
...
void PistonMovingPiece::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
int PistonMovingPiece::getResource(
    int     data,
    Random* random,
...
void PistonMovingPiece::spawnResources(
    ...
    Tile::tiles[entity->getId()]
        ->spawnResources(level, x, y, z, entity->getData(), 0);
}

void PistonMovingPiece::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
...
AABB* PistonMovingPiece::getAABB(
    Level* level,
    int    x,
    int    y,
    int    z,
...
std::shared_ptr<PistonPieceEntity>
