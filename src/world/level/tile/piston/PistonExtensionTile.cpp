...
void PistonExtensionTile::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool PistonExtensionTile::mayPlace(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void PistonExtensionTile::addAABBs(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
void PistonExtensionTile::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
    ...
    if (tile != Tile::pistonBase_Id && tile != Tile::pistonStickyBase_Id) {
        ...
        Tile::tiles[tile]->neighborChanged(
            level,
            x - Facing::STEP_X[facing],
            y - Facing::STEP_Y[facing],
            z - Facing::STEP_Z[facing],
