...
void TripWireTile::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void TripWireTile::playerWillDestroy(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
void TripWireTile::entityInside(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
bool TripWireTile::shouldConnectTo(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
