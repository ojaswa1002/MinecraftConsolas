...
#include "world/item/AnvilTileItem.h"
#include "world/item/ClothTileItem.h"
#include "world/item/ColoredTileItem.h"
#include "world/item/Item.h"
#include "world/item/LeafTileItem.h"
#include "world/item/MultiTextureTileItem.h"
#include "world/item/PistonTileItem.h"
#include "world/item/SaplingTileItem.h"
#include "world/item/SmoothStoneBrickTileItem.h"
#include "world/item/StoneMonsterTileItem.h"
#include "world/item/StoneSlabTileItem.h"
#include "world/item/TileItem.h"
#include "world/item/TreeTileItem.h"
#include "world/item/WaterLilyTileItem.h"
...
#include "world/level/tile/piston/PistonMovingPiece.h"
...
unsigned char
    Tile::_sendTileData[TILE_NUM_COUNT]; // 4J changed - was bool, now bitfield
                                         // to indicate which bits are important
                                         // to be sent
...
void Tile::staticCtor() {
    ...
    Tile::SOUND_LADDER = new Tile::SoundType(
        eMaterialSoundType_LADDER,
        1,
        1,
        eSoundType_DIG_WOOD
    );
    Tile::SOUND_ANVIL = new Tile::SoundType(
    ...
    Tile::goldenRail = (new RailTile(27, true))
                           ...
                           ->disableMipmap();
    Tile::detectorRail = (new DetectorRailTile(28))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_rail,
    ...
    Tile::diamondBlock = (new MetalTile(57))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_block,
    ...
    Tile::sandStone = (new SandStoneTile(24))
                          ->setBaseItemTypeAndMaterial(
                              Item::eBaseItemType_structblock,
                              Item::eMaterial_sand
                          )
                          ->setSoundType(Tile::SOUND_STONE)
                          ->setDestroyTime(0.8f)
    ...
    Tile::redBrick = (new Tile(45, Material::stone))
                         ->setBaseItemTypeAndMaterial(
                             Item::eBaseItemType_structblock,
    ...
    Tile::torch = (new TorchTile(50))
                      ...
                      ->disableMipmap();
    Tile::litPumpkin = (new PumpkinTile(91, true))
                           ->setBaseItemTypeAndMaterial(
                               Item::eBaseItemType_torch,
    ...
    Tile::pistonStickyBase = (PistonBaseTile*)(new PistonBaseTile(29, true))
                                 ->setBaseItemTypeAndMaterial(
                                     Item::eBaseItemType_piston,
    ...
    Tile::deadBush = (DeadBushTile*)(new DeadBushTile(32))
                         ...
                         ->disableMipmap();
    Tile::pistonBase = (PistonBaseTile*)(new PistonBaseTile(33, false))
                           ->setBaseItemTypeAndMaterial(
                               Item::eBaseItemType_piston,
    ...
    Tile::pressurePlate_stone =
        (Tile*)(new PressurePlateTile(
            ...
            ->setBaseItemTypeAndMaterial(
                Item::eBaseItemType_pressureplate,
                Item::eMaterial_stone
            )
            ->setDestroyTime(0.5f)
            ->setSoundType(Tile::SOUND_STONE)
    ...
    Tile::hugeMushroom2 = (new HugeMushroomTile(100, Material::wood, 1))
                              ...
                              ->setUseDescriptionId(IDS_DESC_MUSHROOM)
                              ->sendTileData();
    Tile::ironFence = (new ThinFenceTile(
                           101,
                           L"fenceIron",
                           L"fenceIron",
                           Material::metal,
    ...
    Tile::thinGlass = (new ThinFenceTile(
                           102,
                           L"glass",
                           L"thinglass_top",
                           Material::glass,
    ...
    Tile::stairs_wood = (new StairTile(53, Tile::wood, 0))
                            ->setBaseItemTypeAndMaterial(
                                Item::eBaseItemType_stairs,
                                Item::eMaterial_wood
                            )
    ...
    Tile::stairs_stone = (new StairTile(67, Tile::stoneBrick, 0))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_stairs,
                                 Item::eMaterial_stone
                             )
                             ...
                             ->sendTileData()
                             ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::stairs_bricks = (new StairTile(108, Tile::redBrick, 0))
                              ->setBaseItemTypeAndMaterial(
                                  Item::eBaseItemType_stairs,
                                  Item::eMaterial_brick
                              )
    ...
    Tile::netherBrick = (new Tile(112, Material::stone))
                            ->setBaseItemTypeAndMaterial(
                                Item::eBaseItemType_structblock,
    ...
    Tile::netherFence = (new FenceTile(113, L"netherBrick", Material::stone))
                            ->setBaseItemTypeAndMaterial(
                                Item::eBaseItemType_fence,
                                Item::eMaterial_netherbrick
                            )
    ...
    Tile::enchantTable = (new EnchantmentTableTile(116))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_device,
    ...
    Tile::brewingStand = (new BrewingStandTile(117))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_device,
    ...
    // TU9
    Tile::stairs_sandstone = (new StairTile(128, Tile::sandStone, 0))
                                 ->setBaseItemTypeAndMaterial(
                                     Item::eBaseItemType_stairs,
                                     Item::eMaterial_sand
                                 )
    ...
    Tile::woodStairsJungle =
        (new StairTile(136, Tile::wood, TreeTile::JUNGLE_TRUNK))
            ...
            ->sendTileData()
            ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::button_wood = (new ButtonTile(143, true))
                            ->setBaseItemTypeAndMaterial(
                                Item::eBaseItemType_button,
                                Item::eMaterial_wood
                            )
    ...
    Tile::emeraldBlock = (new MetalTile(133))
                             ->setBaseItemTypeAndMaterial(
                                 Item::eBaseItemType_block,
    ...
    Tile::quartzBlock = (new QuartzBlockTile(155))
                            ->setBaseItemTypeAndMaterial(
                                Item::eBaseItemType_structblock,
    ...
    Tile::woolCarpet = (new WoolCarpetTile(171))
                           ->setBaseItemTypeAndMaterial(
                               Item::eBaseItemType_carpet,
                               Item::eMaterial_cloth
                           )
                           ->setDestroyTime(0.1f)
    ...
    Item::items[Tile::monsterStoneEgg_Id] =
        (new StoneMonsterTileItem(Tile::monsterStoneEgg_Id - 256))
            ...
            ); // 4J - Brought forward from post-1.2 to fix stacking problem
    Item::items[Tile::stoneBrickSmooth_Id] =
        (new SmoothStoneBrickTileItem(
             Tile::stoneBrickSmooth_Id - 256,
             stoneBrickSmooth
         ))
            ->setTextureName(L"stonebricksmooth")
            ->setDescriptionId(IDS_TILE_STONE_BRICK_SMOOTH);
    ...
    Item::items[Tile::stoneSlabHalf_Id] =
        (new StoneSlabTileItem(
            ...
            ->setDescriptionId(IDS_TILE_STONESLAB)
            ->setUseDescriptionId(IDS_DESC_HALFSLAB);
    Item::items[Tile::stoneSlab_Id] = (new StoneSlabTileItem(
                                           Tile::stoneSlab_Id - 256,
                                           Tile::stoneSlabHalf,
                                           Tile::stoneSlab,
                                           true
                                       ))
...
float Tile::getBrightness(LevelSource* level, int x, int y, int z) {
    ...
    // in x/y/z coords
    return level
        ->getBrightness(x, y, z, Tile::lightEmission[level->getTile(x, y, z)]);
}

// 4J - brought forward from 1.8.2
int Tile::
    getLightColor(LevelSource* level, int x, int y, int z, int tileId /*=-1*/) {
    // Lighting fix brought forward from ~1.5 here - used to use the
    // lightEmission level for this tile rather than getting the for the passed
    // in x/y/z coords
    if (tileId == -1) {
        ...
        return level
            ->getLightColor(x, y, z, Tile::lightEmission[tileId], tileId);
    }
}
...
int Tile::getPlacedOnFaceDataValue(
    Level* level,
    int    x,
    int    y,
    int    z,
