...
void StairTile::handleEntityInside(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
int StairTile::getPlacedOnFaceDataValue(
    Level* level,
    int    x,
    int    y,
    int    z,
...
HitResult*
StairTile::clip(Level* level, int xt, int yt, int zt, Vec3* a, Vec3* b) {
    HitResult* results[8];
