...
void SignTileEntity::setChanged() {
    ...
    //if (pMinecraft->level->isClientSide)
    {
        ...
        // at this point, we can ask the online string verifier if our sign text
is ok #ifdef __ORBIS__ m_bVerified=true; #else
...
int SignTileEntity::StringVerifyCallback(
    LPVOID                  lpParam,
