...
void RedStoneDustTile::updatePowerStrength(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void RedStoneDustTile::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
int RedStoneDustTile::checkTarget(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void RedStoneDustTile::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
...
int RedStoneDustTile::getResource(
    int     data,
    Random* random,
...
bool RedStoneDustTile::getDirectSignal(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool RedStoneDustTile::getSignal(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
    ...
    bool w = RedStoneDustTile::shouldReceivePowerFrom(
                 level,
                 x - 1,
                 y,
                 z,
    ...
    bool e = RedStoneDustTile::shouldReceivePowerFrom(
                 level,
                 x + 1,
                 y,
                 z,
    ...
    bool n = RedStoneDustTile::shouldReceivePowerFrom(
                 level,
                 x,
                 y,
                 z - 1,
    ...
    bool s = RedStoneDustTile::shouldReceivePowerFrom(
                 level,
                 x,
                 y,
                 z + 1,
...
void RedStoneDustTile::animateTick(
    Level*  level,
    int     x,
    int     y,
    int     z,
...
bool RedStoneDustTile::shouldConnectTo(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
...
bool RedStoneDustTile::shouldReceivePowerFrom(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
