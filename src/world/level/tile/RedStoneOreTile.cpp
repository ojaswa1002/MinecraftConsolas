...
int RedStoneOreTile::getResourceCountForLootBonus(
    int     bonusLevel,
    Random* random
) {
...
void RedStoneOreTile::spawnResources(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void RedStoneOreTile::animateTick(
    Level*  level,
    int     x,
    int     y,
    int     z,
...
RedStoneOreTile::getSilkTouchItemInstance(int data) {
