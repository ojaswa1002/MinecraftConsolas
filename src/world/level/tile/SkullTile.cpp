...
: EntityTile(id, Material::decoration, isSolidRender()) {
...
void SkullTile::playerWillDestroy(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
void SkullTile::onRemove(Level* level, int x, int y, int z) //, int id, int
                                                            // data)
{
