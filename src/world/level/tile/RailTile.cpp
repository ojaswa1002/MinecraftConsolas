...
HitResult*
RailTile::clip(Level* level, int xt, int yt, int zt, Vec3* a, Vec3* b) {
...
bool RailTile::findGoldenRailSignal(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool RailTile::isGoldenRailWithPower(
    Level* level,
    int    x,
    int    y,
    int    z,
