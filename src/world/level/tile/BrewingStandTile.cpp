...
: EntityTile(id, Material::metal, isSolidRender()) {
    random   = new Random();
    iconBase = NULL;
}
...
void BrewingStandTile::addAABBs(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
void BrewingStandTile::animateTick(
    Level*  level,
    int     xt,
    int     yt,
    int     zt,
...
void BrewingStandTile::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
int BrewingStandTile::getResource(
    int     data,
    Random* random,
