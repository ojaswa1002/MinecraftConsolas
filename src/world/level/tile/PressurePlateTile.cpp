...
bool PressurePlateTile::isPathfindable(
    LevelSource* level,
    int          x,
    int          y,
    int          z
...
void PressurePlateTile::neighborChanged(
    Level* level,
    int    x,
    int    y,
    int    z,
...
void PressurePlateTile::entityInside(
    Level*                  level,
    int                     x,
    int                     y,
    int                     z,
...
void PressurePlateTile::onRemove(
    Level* level,
    int    x,
    int    y,
    int    z,
...
bool PressurePlateTile::getSignal(
    LevelSource* level,
    int          x,
    int          y,
    int          z,
...
bool PressurePlateTile::getDirectSignal(
    Level* level,
    int    x,
    int    y,
    int    z,
