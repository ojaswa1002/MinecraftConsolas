...
: EntityTile(id, Material::stone, isSolidRender()) {
    updateDefaultShape();
}
...
int EnderChestTile::getResource(
    int     data,
    Random* random,
...
void EnderChestTile::setPlacedBy(
    Level*               level,
    int                  x,
    int                  y,
    int                  z,
...
void EnderChestTile::animateTick(
    Level*  level,
    int     xt,
    int     yt,
    int     zt,
