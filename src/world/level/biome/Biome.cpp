...
void Biome::staticCtor() {
    ...
    Biome::plains = (new PlainsBiome(1))
                        ->setColor(0x8db360)
                        ->setName(L"Plains")
    ...
    Biome::desert = (new DesertBiome(2))
                        ->setColor(0xFA9418)
                        ->setName(L"Desert")
                        ->setNoRain()
    ...
    Biome::extremeHills = (new ExtremeHillsBiome(3))
                              ->setColor(0x606060)
    ...
    Biome::swampland = (new SwampBiome(6))
                           ->setColor(0x07F9B2)
                           ->setName(L"Swampland")
    ...
    Biome::frozenOcean = (new OceanBiome(10))
                             ->setColor(0x9090a0)
    ...
    Biome::frozenRiver = (new RiverBiome(11))
                             ->setColor(0xa0a0ff)
    ...
    Biome::iceFlats = (new IceBiome(12))
                          ->setColor(0xffffff)
    ...
    Biome::iceMountains = (new IceBiome(13))
                              ->setColor(0xa0a0a0)
    ...
    Biome::beaches = (new BeachBiome(16))
                         ->setColor(0xfade55)
                         ->setName(L"Beach")
                         ->setTemperatureAndDownfall(0.8f, 0.4f)
    ...
    Biome::desertHills = (new DesertBiome(17))
                             ->setColor(0xd25f12)
    ...
    Biome::forestHills = (new ForestBiome(18))
                             ->setColor(0x22551c)
    ...
    Biome::taigaHills = (new TaigaBiome(19))
                            ->setColor(0x163933)
    ...
    Biome::jungle = (new JungleBiome(21))
                        ->setColor(0x537b09)
                        ->setName(L"Jungle")
    ...
    Biome::jungleHills = (new JungleBiome(22))
                             ->setColor(0x2c4205)
...
Biome::Biome(int id) : id(id) {
    ...
    */
    ...
    friendlies_chicken.push_back(
        new MobSpawnerData(eTYPE_CHICKEN, 10, 4, 4)
    ); // 4J - moved chickens to their own category
