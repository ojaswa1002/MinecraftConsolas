...
bool EmptyLevelChunk::setTileAndData(
    int x,
    int y,
    int z,
    int _tile,
...
int EmptyLevelChunk::getBrightness(
...
// 4J added
void EmptyLevelChunk::getNeighbourBrightnesses(
    int*                brightnesses,
    LightLayer::variety layer,
    int                 x,
    int                 y,
...
void EmptyLevelChunk::setBrightness(
    LightLayer::variety layer,
    int                 x,
    int                 y,
    int                 z,
...
void EmptyLevelChunk::getEntities(
...
int EmptyLevelChunk::getBlocksAndData(
    byteArray data,
    int       x0,
    int       y0,
    int       z0,
...
int EmptyLevelChunk::setBlocksAndData(
    byteArray data,
    int       x0,
    int       y0,
    int       z0,
...
bool EmptyLevelChunk::testSetBlocksAndData(
    byteArray data,
    int       x0,
    int       y0,
    int       z0,
