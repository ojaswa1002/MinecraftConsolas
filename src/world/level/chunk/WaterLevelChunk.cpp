...
bool WaterLevelChunk::setTileAndData(
    int x,
    int y,
    int z,
    int _tile,
...
void WaterLevelChunk::setBrightness(
...
void WaterLevelChunk::getEntities(
...
int WaterLevelChunk::setBlocksAndData(
    byteArray data,
    int       x0,
    int       y0,
    int       z0,
...
bool WaterLevelChunk::testSetBlocksAndData(
    byteArray data,
    int       x0,
    int       y0,
    int       z0,
...
Random* WaterLevelChunk::getRandom(std::int64_t l) {
    return new Random(
...
void WaterLevelChunk::setLevelChunkBrightness(
    LightLayer::variety layer,
    int                 x,
    int                 y,
    int                 z,
