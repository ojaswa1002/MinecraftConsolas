...
#define ArrayCopyFunctionDeclaration(x)                                        \
    static void arraycopy(                                                     \
        arrayWithLength<x>  src,                                               \
        unsigned int        srcPos,                                            \
        arrayWithLength<x>* dst,                                               \
        unsigned int        dstPos,                                            \
        unsigned int        length                                             \
    );
...
public:
    ArrayCopyFunctionDeclaration(byte) ArrayCopyFunctionDeclaration(
        Node*
    ...
    static std::int64_t currentRealTimeMillis(); // 4J Added to get real-world
                                                 // time for timestamps in saves
