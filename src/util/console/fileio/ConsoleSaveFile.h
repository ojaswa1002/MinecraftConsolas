...
public:
    ...
    virtual std::vector<FileEntry*>*
    getFilesWithPrefix(const std::wstring& prefix) = 0;
    virtual std::vector<FileEntry*>*
    getRegionFilesByDimension(unsigned int dimensionIndex) = 0;

#if defined(__PS3__) || defined(__ORBIS__) || defined(__PSVITA__)
    virtual std::wstring
    getPlayerDataFilenameForLoad(const PlayerUID& pUID) = 0;
    virtual std::wstring
    getPlayerDataFilenameForSave(const PlayerUID& pUID)       = 0;
