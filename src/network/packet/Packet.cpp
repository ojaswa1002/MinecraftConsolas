...
#include "nbt/NbtIo.h"
#include "util/java/Exceptions.h"
...
void Packet::staticCtor() {
    ...
    map(13,
        ...
        true,
        true,
        typeid(MovePlayerPacket::PosRot),
    ...
    map(17,
        ...
        true,
        false,
        typeid(EntityActionAtPositionPacket),
    ...
    map(
        ...
        false,
        false,
        typeid(AddExperienceOrbPacket),
        AddExperienceOrbPacket::create
    ); // TODO New for 1.8.2 - Needs sendToAny?
    ...
    map(33,
        ...
        false,
        true,
        typeid(MoveEntityPacket::PosRot),
    ...
    map(
        ...
        true,
        true,
        typeid(BlockRegionUpdatePacket),
        BlockRegionUpdatePacket::create
    ); // Changed to LevelChunkPacket in Java but we aren't using that
    map(52,
        true,
        false,
        true,
        true,
        typeid(ChunkTilesUpdatePacket),
    ...
    map(104,
        ...
        true,
        false,
        typeid(ContainerSetContentPacket),
    ...
    map(107,
        ...
        true,
        false,
        typeid(SetCreativeModeSlotPacket),
    ...
    map(108,
        ...
        false,
        false,
        typeid(ContainerButtonClickPacket),
    ...
    map(153,
        ...
        false,
        false,
        typeid(ServerSettingsChangedPacket),
    ...
    map(155,
        ...
        true,
        true,
        typeid(ChunkVisibilityAreaPacket),
    ...
    map(158,
        ...
        true,
        false,
        typeid(UpdateGameRuleProgressPacket),
    ...
    map(160,
        ...
        true,
        false,
        typeid(TextureAndGeometryPacket),
    ...
    map(161,
        ...
        true,
        false,
        typeid(TextureAndGeometryChangePacket),
    ...
    map(163,
        ...
        false,
        true,
        typeid(MoveEntityPacketSmall::Pos),
    ...
    map(164,
        ...
        false,
        true,
        typeid(MoveEntityPacketSmall::Rot),
    ...
    map(165,
        ...
        false,
        true,
        typeid(MoveEntityPacketSmall::PosRot),
...
#ifndef _CONTENT_PACKAGE
#if PACKET_ENABLE_STAT_TRACKING
    auto it = outgoingStatistics.find(packet->getId());
...
void Packet::renderPacketStats(int id) {
    auto it = outgoingStatistics.find(id);
...
void Packet::renderAllPacketStats() {
    ...
    pMinecraft->gui->renderStackedGraph(
        Packet::renderPos,
        512,
...
void Packet::renderAllPacketStatsKey() {
    ...
    for (unsigned int i = 0; i < total; ++i) {
        ...
        pMinecraft->gui->drawString(
            pMinecraft->font,
            stat->getLegendString(),
            900,
            30 + (10 * i),
            colour
        );
...
std::int64_t
Packet::getIndexedStatValue(unsigned int samplePos, unsigned int renderableId) {
    std::int64_t val = 0;
...
) // throws IOException TODO 4J JEV, should this declare a throws?
{
    ...
    packet = getPacket(id);
    if (packet == NULL)
        assert(false); // throw new IOException(std::wstring(L"Bad packet id ")
                       // + _toString<int>(id));
...
void Packet::PacketStatistics::renderStats() {
    ...
    Minecraft* pMinecraft = Minecraft::GetInstance();
    pMinecraft->gui
        ->renderGraph(512, samplesPos, countSamples, 1, 10, sizeSamples, 1, 50);
#endif
#endif
}
...
std::wstring Packet::PacketStatistics::getLegendString() {
    ...
    swprintf(
        ...
        id,
        countSamples[(samplesPos - 1) & (512 - 1)],
        count,
        sizeSamples[(samplesPos - 1) & (512 - 1)],
        totalSize,
        bps
    );
    return string;
