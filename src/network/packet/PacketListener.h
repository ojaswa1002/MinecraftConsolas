...
public:
    ...
    virtual void
    handleBlockRegionUpdate(std::shared_ptr<BlockRegionUpdatePacket> packet);
    ...
    virtual void
    handleChunkTilesUpdate(std::shared_ptr<ChunkTilesUpdatePacket> packet);
    ...
    virtual void
    handleChunkVisibility(std::shared_ptr<ChunkVisibilityPacket> packet);
    ...
    virtual void
    handleMoveEntitySmall(std::shared_ptr<MoveEntityPacketSmall> packet);
    virtual void
    handleTeleportEntity(std::shared_ptr<TeleportEntityPacket> packet);
    virtual void handleUseItem(std::shared_ptr<UseItemPacket> packet);
    virtual void
    handleSetCarriedItem(std::shared_ptr<SetCarriedItemPacket> packet);
    virtual void
    handleRemoveEntity(std::shared_ptr<RemoveEntitiesPacket> packet);
    virtual void
    handleTakeItemEntity(std::shared_ptr<TakeItemEntityPacket> packet);
    ...
    virtual void
    handlePlayerCommand(std::shared_ptr<PlayerCommandPacket> packet);
    ...
    virtual void
    handleSetEntityMotion(std::shared_ptr<SetEntityMotionPacket> packet);
    virtual void
    handleSetEntityData(std::shared_ptr<SetEntityDataPacket> packet);
    ...
    virtual void
    handleContainerOpen(std::shared_ptr<ContainerOpenPacket> packet);
    virtual void
    handleContainerClose(std::shared_ptr<ContainerClosePacket> packet);
    virtual void
    handleContainerClick(std::shared_ptr<ContainerClickPacket> packet);
    virtual void
    handleContainerSetSlot(std::shared_ptr<ContainerSetSlotPacket> packet);
    virtual void
    handleContainerContent(std::shared_ptr<ContainerSetContentPacket> packet);
    ...
    virtual void
    handleSetEquippedItem(std::shared_ptr<SetEquippedItemPacket> packet);
    ...
    virtual void
    handleAddGlobalEntity(std::shared_ptr<AddGlobalEntityPacket> packet);
    virtual void
    handleComplexItemData(std::shared_ptr<ComplexItemDataPacket> packet);
    ...
    virtual void
    handleUpdateMobEffect(std::shared_ptr<UpdateMobEffectPacket> packet);
    virtual void
    handleRemoveMobEffect(std::shared_ptr<RemoveMobEffectPacket> packet);
    ...
    virtual void
    handleSetExperience(std::shared_ptr<SetExperiencePacket> packet);
    virtual void handleSetCreativeModeSlot(
        std::shared_ptr<SetCreativeModeSlotPacket> packet
    );
    virtual void
    handleAddExperienceOrb(std::shared_ptr<AddExperienceOrbPacket> packet);
    ...
    // 1.2.3
    virtual void
    handleRotateMob(std::shared_ptr<RotateHeadPacket> rotateMobPacket);

    // 1.3.2
    virtual void
    handleClientProtocolPacket(std::shared_ptr<ClientProtocolPacket> packet);
    virtual void
    handleServerAuthData(std::shared_ptr<ServerAuthDataPacket> packet);
    ...
    virtual void
    handleChatAutoComplete(std::shared_ptr<ChatAutoCompletePacket> packet);
    virtual void
    handleClientInformation(std::shared_ptr<ClientInformationPacket> packet);
    virtual void handleSoundEvent(std::shared_ptr<LevelSoundPacket> packet);
    virtual void
    handleTileDestruction(std::shared_ptr<TileDestructionPacket> packet);
    virtual void
    handleClientCommand(std::shared_ptr<ClientCommandPacket> packet);
    ...
    virtual void
    handleTextureAndGeometry(std::shared_ptr<TextureAndGeometryPacket> packet);
    virtual void handleChunkVisibilityArea(
        std::shared_ptr<ChunkVisibilityAreaPacket> packet
    );
    virtual void
    handleUpdateProgress(std::shared_ptr<UpdateProgressPacket> packet);
    virtual void
    handleTextureChange(std::shared_ptr<TextureChangePacket> packet);
