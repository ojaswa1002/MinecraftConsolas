...
#ifdef _XBOX
void StatsCounter::setLeaderboardProperty(
    XUSER_PROPERTY* prop,
    DWORD           id,
    unsigned int    value
) {
    ...
    prop->value.nData =
        (int)(value & 0x7FFFFFFF); // Just making sure we clamp the unsigned int
                                   // to the max val for a signed int
}
...
void StatsCounter::writeStats() {
    ...
    if (modifiedBoards & LEADERBOARD_MININGBLOCKS_PEACEFUL) {
        ...
        scores[viewCount].m_commentData.m_mining.m_cobblestone = getValue(
            Stats::blocksMined[Tile::stoneBrick->id],
        ...
        scores[viewCount].m_commentData.m_mining.m_gravel = getValue(
            Stats::blocksMined[Tile::gravel->id],
            eDifficulty_Peaceful
        );
        ...
        scores[viewCount].m_commentData.m_mining.m_obsidian = getValue(
            Stats::blocksMined[Tile::obsidian->id],
            eDifficulty_Peaceful
        );
    ...
    if (modifiedBoards & LEADERBOARD_FARMING_PEACEFUL) {
        ...
        scores[viewCount].m_commentData.m_farming.m_eggs = getValue(
            Stats::itemsCollected[Item::egg->id],
            eDifficulty_Peaceful
        );
        ...
        scores[viewCount].m_commentData.m_farming.m_mushroom = getValue(
            Stats::blocksMined[Tile::mushroom1_Id],
            eDifficulty_Peaceful
        );
        ...
        scores[viewCount].m_commentData.m_farming.m_pumpkin = getValue(
            Stats::itemsCollected[Tile::pumpkin->id],
            eDifficulty_Peaceful
        );
    ...
    if (modifiedBoards & LEADERBOARD_KILLS_NORMAL) {
        ...
        // ], PROPERTY_KILLS_ZOMBIEPIGMAN,	getValue(Stats::killsZombiePigman,
        // eDifficulty_Normal) + getValue(Stats::killsNetherZombiePigman,
        // eDifficulty_Normal) );
        setLeaderboardProperty(
            &killsNormalProperties
                [LeaderboardManager::eProperty_Kills_ZombiePigman],
    ...
    if (modifiedBoards & LEADERBOARD_KILLS_HARD) {
        ...
        // ], PROPERTY_KILLS_ZOMBIEPIGMAN,	getValue(Stats::killsZombiePigman,
        // eDifficulty_Hard) + getValue(Stats::killsNetherZombiePigman,
        // eDifficulty_Hard) );
        setLeaderboardProperty(
            &killsHardProperties
                [LeaderboardManager::eProperty_Kills_ZombiePigman],
...
void StatsCounter::setupStatBoards() {
    ...
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::dirt->id],
    ...
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::sand->id],
            LEADERBOARD_MININGBLOCKS_PEACEFUL
        )
    );
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::rock->id],
            LEADERBOARD_MININGBLOCKS_PEACEFUL
        )
    );
    statBoards.insert(
    ...
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::clay->id],
            LEADERBOARD_MININGBLOCKS_PEACEFUL
        )
    );
    statBoards.insert(
    ...
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::crops_Id],
            LEADERBOARD_FARMING_PEACEFUL
        )
    );
    statBoards.insert(
    ...
    statBoards.insert(
        std::make_pair(
            Stats::blocksMined[Tile::reeds_Id],
            LEADERBOARD_FARMING_PEACEFUL
        )
    );
    statBoards.insert(
