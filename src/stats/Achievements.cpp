...
#include "platform/Console_Awards_enum.h"
...
void Achievements::staticCtor() {
    Achievements::openInventory = (new Achievement(
                                      ...
                                      ->setAwardLocallyOnly()
                                      ->postConstruct();
    Achievements::mineWood = (new Achievement(
                                  eAward_GettingWood,
                                  L"mineWood",
                                  2,
                                  1,
                                 ...
                                 ->postConstruct();
    Achievements::buildWorkbench = (new Achievement(
                                        eAward_Benchmarking,
                                        L"buildWorkBench",
                                        4,
                                        -1,
                                       ...
                                       ->postConstruct();
    Achievements::buildPickaxe = (new Achievement(
                                      eAward_TimeToMine,
                                      L"buildPickaxe",
                                      4,
                                      2,
                                     ...
                                     ->postConstruct();
    Achievements::buildFurnace = (new Achievement(
                                      eAward_HotTopic,
                                      L"buildFurnace",
                                      3,
                                      4,
                                     ...
                                     ->postConstruct();
    Achievements::acquireIron = (new Achievement(
                                    ...
                                    ->postConstruct();
    Achievements::buildHoe = (new Achievement(
                                  eAward_TimeToFarm,
                                  L"buildHoe",
                                  2,
                                  -3,
                                 ...
                                 ->postConstruct();
    Achievements::makeBread = (new Achievement(
                                   eAward_BakeBread,
                                   L"makeBread",
                                   -1,
                                   -3,
                                  ...
                                  ->postConstruct();
    Achievements::bakeCake = (new Achievement(
                                  eAward_TheLie,
                                  L"bakeCake",
                                  0,
                                  -5,
                                 ...
                                 ->postConstruct();
    Achievements::buildBetterPickaxe = (new Achievement(
                                            eAward_GettingAnUpgrade,
                                            L"buildBetterPickaxe",
                                            6,
                                            2,
                                            Item::pickAxe_stone,
                                            (Achievement*)buildPickaxe
                                           ...
                                           ->postConstruct();
    Achievements::cookFish = (new Achievement(
    ...
    Achievements::onARail = (new Achievement(
                                ...
                                ->setGolden()
                                ->postConstruct();
    Achievements::buildSword = (new Achievement(
                                    eAward_TimeToStrike,
                                    L"buildSword",
                                    6,
                                    -1,
                                   ...
                                   ->postConstruct();
    Achievements::killEnemy = (new Achievement(
                                  ...
                                  ->postConstruct();
    Achievements::killCow = (new Achievement(
                                 eAward_CowTipper,
                                 L"killCow",
                                 7,
                                 -3,
                                ...
                                ->postConstruct();
    Achievements::flyPig = (new Achievement(
                                eAward_WhenPigsFly,
                                L"flyPig",
                                8,
                                -4,
    ...
    Achievements::leaderOfThePack = (new Achievement(
                                        ...
                                        ->setAwardLocallyOnly()
                                        ->postConstruct();
    Achievements::MOARTools = (new Achievement(
                                   eAward_MOARTools,
                                   L"MOARTools",
                                   0,
                                   0,
                                  ...
                                  ->setAwardLocallyOnly()
                                  ->postConstruct();
    Achievements::dispenseWithThis = (new Achievement(
                                         ...
                                         ->postConstruct();
    Achievements::InToTheNether = (new Achievement(
    ...
    // 4J : WESTY : Added other awards.
    Achievements::mine100Blocks = (new Achievement(
                                      ...
                                      ->setAwardLocallyOnly()
                                      ->postConstruct();
    Achievements::kill10Creepers = (new Achievement(
                                       ...
                                       ->postConstruct();
#ifdef _EXTENDED_ACHIEVEMENTS
    Achievements::eatPorkChop = (new Achievement(
                                     eAward_eatPorkChop,
                                     L"eatPorkChop",
                                     0,
                                     0,
    ...
    Achievements::eatPorkChop = (new Achievement(
                                    ...
                                    ->postConstruct();
#endif
    Achievements::play100Days = (new Achievement(
                                     eAward_play100Days,
                                     L"play100Days",
                                     0,
                                     0,
                                    ...
                                    ->setAwardLocallyOnly()
                                    ->postConstruct();
    Achievements::arrowKillCreeper = (new Achievement(
                                         ...
                                         ->postConstruct();
    Achievements::socialPost = (new Achievement(
                                    eAward_socialPost,
                                    L"socialPost",
                                    0,
                                    0,
    ...
    // achievements
    Achievements::snipeSkeleton = (new Achievement(
    ...
    Achievements::diamonds = (new Achievement(
                                  eAward_diamonds,
                                  L"diamonds",
                                  -1,
                                  5,
                                 ...
                                 ->postConstruct();
    // Achievements::portal				= (new Achievement(eAward_portal,
    // L"portal",				-1, 7,	Tile::obsidian,		(Achievement
    // *)diamonds) )->postConstruct();
    Achievements::ghast = (new Achievement(
                               eAward_ghast,
                               L"ghast",
                               -4,
                               8,
                              ...
                              ->setGolden()
                              ->postConstruct();
    Achievements::blazeRod = (new Achievement(
                                  eAward_blazeRod,
                                  L"blazeRod",
                                  0,
                                  9,
                                 ...
                                 ->postConstruct();
    Achievements::potion = (new Achievement(
                                eAward_potion,
                                L"potion",
                                2,
                                8,
                               ...
                               ->postConstruct();
    Achievements::theEnd = (new Achievement(
                                eAward_theEnd,
                                L"theEnd",
                                3,
                                10,
                               ...
                               ->setGolden()
                               ->postConstruct();
    Achievements::winGame = (new Achievement(
                                 eAward_winGame,
                                 L"theEnd2",
                                 4,
                                 13,
                                ...
                                ->setGolden()
                                ->postConstruct();
    Achievements::enchantments = (new Achievement(
                                      eAward_enchantments,
                                      L"enchantments",
                                      -4,
                                      4,
                                     ...
                                     ->postConstruct();
    //   Achievements::overkill				= (new Achievement(eAward_overkill,
    //   L"overkill",			-4, 1,	Item::sword_diamond, (Achievement
    //   *)enchantments) )->setGolden()->postConstruct(); Achievements::bookcase
    //   = (new Achievement(eAward_bookcase,				L"bookcase",
    //   -3, 6,	Tile::bookshelf,	(Achievement *)enchantments)
    //   )->postConstruct();
#endif

#ifdef _EXTENDED_ACHIEVEMENTS
    Achievements::overkill = (new Achievement(
                                  eAward_overkill,
                                  L"overkill",
                                  -4,
                                  1,
                                 ...
                                 ->setGolden()
                                 ->postConstruct();
    Achievements::bookcase = (new Achievement(
                                  eAward_bookcase,
                                  L"bookcase",
                                  -3,
                                  6,
    ...
    Achievements::adventuringTime = (new Achievement(
                                        ...
                                        ->setAwardLocallyOnly()
                                        ->postConstruct();
    Achievements::repopulation = (new Achievement(
                                      eAward_repopulation,
                                      L"repopulation",
                                      0,
                                      0,
    ...
    // // // //
    Achievements::diamondsToYou = (new Achievement(
                                      ...
                                      ->postConstruct();
    // Achievements::passingTheTime		= (new Achievement(eAward_play100Days,
    // L"passingTheTime",			0,0,	Tile::bookshelf,
    // (Achievement*) NULL) )->postConstruct(); Achievements::archer
    // = (new Achievement(eAward_arrowKillCreeper,			L"archer",
    // 0,0,	Tile::bookshelf,		(Achievement*) NULL) )->postConstruct();
    Achievements::theHaggler = (new Achievement(
                                    eAward_theHaggler,
                                    L"theHaggler",
                                    0,
                                    0,
                                   ...
                                   ->setAwardLocallyOnly()
                                   ->postConstruct();
    Achievements::potPlanter = (new Achievement(
                                    eAward_potPlanter,
                                    L"potPlanter",
                                    0,
                                    0,
                                   ...
                                   ->setAwardLocallyOnly()
                                   ->postConstruct();
    Achievements::itsASign = (new Achievement(
                                  eAward_itsASign,
                                  L"itsASign",
                                  0,
                                  0,
                                 ...
                                 ->setAwardLocallyOnly()
                                 ->postConstruct();
    Achievements::ironBelly = (new Achievement(
                                   eAward_ironBelly,
                                   L"ironBelly",
                                   0,
                                   0,
                                  ...
                                  ->postConstruct();
    Achievements::haveAShearfulDay = (new Achievement(
                                         ...
                                         ->postConstruct();
    Achievements::rainbowCollection = (new Achievement(
                                          ...
                                          ->setAwardLocallyOnly()
                                          ->postConstruct();
    Achievements::stayinFrosty = (new Achievement(
                                      eAward_stayinFrosty,
                                      L"stayingFrosty",
                                      0,
                                      0,
                                     ...
                                     ->postConstruct();
    Achievements::chestfulOfCobblestone = (new Achievement(
                                               eAward_chestfulOfCobblestone,
                                               L"chestfulOfCobblestone",
                                               0,
                                               0,
                                               Tile::bookshelf,
                                               (Achievement*)NULL
                                              ...
                                              ->setAwardLocallyOnly()
                                              ->postConstruct();
    Achievements::renewableEnergy = (new Achievement(
                                        ...
                                        ->postConstruct();
    Achievements::musicToMyEars = (new Achievement(
                                      ...
                                      ->postConstruct();
    Achievements::bodyGuard = (new Achievement(
                                   eAward_bodyGuard,
                                   L"bodyGuard",
                                   0,
                                   0,
                                  ...
                                  ->postConstruct();
    Achievements::ironMan = (new Achievement(
                                 eAward_ironMan,
                                 L"ironMan",
                                 0,
                                 0,
                                ...
                                ->postConstruct();
    Achievements::zombieDoctor = (new Achievement(
                                      eAward_zombieDoctor,
                                      L"zombieDoctor",
                                      0,
                                      0,
                                     ...
                                     ->postConstruct();
    Achievements::lionTamer = (new Achievement(
                                   eAward_lionTamer,
                                   L"lionTamer",
                                   0,
                                   0,
