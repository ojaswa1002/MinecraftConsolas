...
byteArray GenericStats::getParam_itemsUsed(
...
byteArray GenericStats::getParam_mobKill(
    std::shared_ptr<Player> plr,
...
byteArray GenericStats::param_itemsUsed(
    std::shared_ptr<Player>       plr,
    std::shared_ptr<ItemInstance> itm
) {
...
byteArray GenericStats::param_mobKill(
    std::shared_ptr<Player> plr,
    std::shared_ptr<Mob>    mob,
    DamageSource*           dmgSrc
) {
