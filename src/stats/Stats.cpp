...
void Stats::staticCtor() {
    Stats::walkOneM = (new GeneralStat(
                           2000,
                           L"stat.walkOneM",
                          ...
                          ->setAwardLocallyOnly()
                          ->postConstruct();
    Stats::swimOneM = (new GeneralStat(
                           2001,
                           L"stat.swimOneM",
                           (StatFormatter*)Stat::distanceFormatter
                       ))
                          ->setAwardLocallyOnly()
                          ->postConstruct();
    Stats::fallOneM = (new GeneralStat(
                           2002,
                           L"stat.fallOneM",
                           (StatFormatter*)Stat::distanceFormatter
                       ))
                          ->setAwardLocallyOnly()
                          ->postConstruct();
    Stats::climbOneM = (new GeneralStat(
                            2003,
                            L"stat.climbOneM",
                            (StatFormatter*)Stat::distanceFormatter
                        ))
                           ->setAwardLocallyOnly()
                           ->postConstruct();
    Stats::minecartOneM = (new GeneralStat(
                               2004,
                               L"stat.minecartOneM",
                               (StatFormatter*)Stat::distanceFormatter
                           ))
                              ->setAwardLocallyOnly()
                              ->postConstruct();
    Stats::boatOneM = (new GeneralStat(
                           2005,
                           L"stat.boatOneM",
                           (StatFormatter*)Stat::distanceFormatter
                       ))
...
void Stats::buildBlockStats() {
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 1,
        L"mineBlock.stone",
        Tile::stoneBrick->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 3,
        L"mineBlock.cobblestone",
        Tile::rock->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 6,
        L"mineBlock.obsidian",
        Tile::obsidian->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 11,
        L"mineBlock.redstone",
        Tile::redStoneOre->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 12,
        L"mineBlock.lapisLazuli",
        Tile::lapisOre->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 13,
        L"mineBlock.netherrack",
        Tile::hellRock->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 14,
        L"mineBlock.soulSand",
        Tile::hellSand->id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 15,
        L"mineBlock.glowstone",
        Tile::lightGem->id
    );
    blocksMinedStats->push_back(newStat);
...
void Stats::buildCraftableStats() {
    ...
    newStat = new ItemStat(
        BLOCKS_MINED_OFFSET + 19,
        L"mineBlock.mushroom1",
        Tile::mushroom1_Id
    );
    blocksMinedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_COLLECTED_OFFSET + 4,
        L"collectItem.pumpkin",
        Tile::pumpkin->id
    );
    itemsCollectedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 1,
        L"craftItem.workbench",
        Tile::workBench->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 3,
        L"craftItem.woodenShovel",
        Item::shovel_wood->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    // 4J : WESTY : Added for new achievements.
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 4,
        L"craftItem.woodenPickAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 5,
        L"craftItem.stonePickAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 6,
        L"craftItem.ironPickAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 7,
        L"craftItem.diamondPickAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 8,
        L"craftItem.goldPickAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 9,
        L"craftItem.stoneShovel",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 10,
        L"craftItem.ironShovel",
        Item::shovel_iron->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 11,
        L"craftItem.diamondShovel",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 12,
        L"craftItem.goldShovel",
        Item::shovel_gold->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 13,
        L"craftItem.woodenAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 14,
        L"craftItem.stoneAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 16,
        L"craftItem.diamondAxe",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 18,
        L"craftItem.woodenHoe",
        Item::hoe_wood->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 19,
        L"craftItem.stoneHoe",
        Item::hoe_stone->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 21,
        L"craftItem.diamondHoe",
        Item::hoe_diamond->id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 23,
        L"craftItem.glowstone",
        Tile::lightGem_Id
    );
    itemsCraftedStats->push_back(newStat);
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 27,
        L"craftItem.flintAndSteel",
    ...
    newStat = new ItemStat(
        ITEMS_CRAFTED_OFFSET + 28,
        L"craftItem.fishingRod",
        Item::fishingRod->id
    );
    itemsCraftedStats->push_back(newStat);
...
void Stats::buildAdditionalStats() {
...
#if (defined _EXTENDED_ACHIEVEMENTS) && (!defined _DURANGO)
    {
        ...
        // 4J-JEV:	WHY ON EARTH DO THESE ARRAYS HAVE TO BE SO PAINFULLY LARGE
        // WHEN THEY ARE GOING TO BE MOSTLY EMPTY!!!
        //			Either way, I'm making this one smaller because we don't
        // need those record items (and we only need 2).
        blocksPlaced = StatArray(1000);

        itemStat = new ItemStat(
            offset++,
            L"blockPlaced.flowerPot",
            Tile::flowerPot_Id
        );
        ...
        for (unsigned int i = 0; i < 16; i++) {
            generalStat = new GeneralStat(
                offset++,
                L"rainbowCollection." + _toString<unsigned int>(i)
            );
        ...
        for (unsigned int i = 0; i < 23; i++) {
            generalStat = new GeneralStat(
                offset++,
                L"biomesVisited." + _toString<unsigned int>(i)
            );
            generalStats->push_back(generalStat);
