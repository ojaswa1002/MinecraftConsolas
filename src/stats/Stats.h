...
public:
    ...
    static Stat*
        timePlayed; // Game time, recored as ticks, with TICKS_PER_DAY ticks per
                    // day! Stored as large stat so it doesn't max out before
                    // reaching 100 days ( 2,400,000 ticks ).
